var rt=Object.defineProperty;var lt=(t,e,o)=>e in t?rt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var c=(t,e,o)=>lt(t,typeof e!="symbol"?e+"":e,o);import{i as d,d as we,I as R,q as K,j as Le,s as ye,a2 as l,Q as be,u as _,C as qe,x as re,m as Xe,t as ee,X as te,f as Ye,e as se,a as Z,y as Ke,Y as ct,B as dt,E as ut,a1 as j,_ as ht,g as Re,G as xe,p as ft,z as pt,a5 as mt,A as vt,W as gt,o as wt,P as yt,H as bt,S as Ct,h as St}from"./three-uBnUpQ-C.js";import{b as xt,R as Pt,a as At,B as de,C as Tt,V as Et,N as kt,S as Mt,G as It,c as ue,E as Lt}from"./postprocessing-DQ1XEIde.js";import{g as V}from"./gsap-SFc2wnMY.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();function Ne(t){return t*t*t*(t*(t*6-15)+10)}function he(t,e,o){return t+o*(e-t)}function oe(t,e,o){const i=t&3,n=i<2?e:o,s=i<2?o:e;return(t&1?-n:n)+(t&2?-s:s)}const M=Array.from({length:512},(t,e)=>e).sort(()=>Math.random()-.5);for(let t=0;t<256;t++)M[t+256]=M[t];function Rt(t,e){const o=Math.floor(t)&255,i=Math.floor(e)&255,n=t-Math.floor(t),s=e-Math.floor(e),r=Ne(n),a=Ne(s),f=M[M[o]+i],u=M[M[o]+i+1],p=M[M[o+1]+i],w=M[M[o+1]+i+1];return he(he(oe(f,n,s),oe(p,n-1,s),r),he(oe(u,n,s-1),oe(w,n-1,s-1),r),a)}function Fe(t,e,o=4,i=2,n=.5){let s=0,r=.5,a=1;for(let f=0;f<o;f++)s+=Rt(t*a,e*a)*r,a*=i,r*=n;return s}function A(t,e){return t+Math.random()*(e-t)}function Ue(t,e){return Math.floor(A(t,e+1))}const Nt=`
...
`,E=32,H=16,_t=6,J=H+_t,ne=E/2*J,fe={color:new d(197400),near:100,far:500},Q=[new d(62975),new d(62975),new d(16711850),new d(16711850),new d(16739098),new d(8073215),new d(8073215),new d(65416),new d(65416),new d(16770626)];function Vt(){return new te({vertexShader:Nt,fragmentShader:Ft,uniforms:{uTime:{value:0},uFogColor:{value:fe.color},uFogNear:{value:fe.near},uFogFar:{value:fe.far}}})}function $t(t,e){const o=t/E,i=e/E;return o<.35&&i<.35?0:o<.65&&i<.35?1:o>=.65&&i<.35?2:o<.35&&i<.65?3:o>=.65&&i<.65?4:o<.35&&i>=.65?5:o<.65&&i>=.65?6:o>=.65&&i>=.65?7:i>.45&&i<.55?8:9}class qt{constructor(){c(this,"meshA");c(this,"meshB");c(this,"meshC");c(this,"mats",[])}generate(e){const o=E*E,i=Vt();this.mats.push(i);const n=new we(1,1,1),s=new Float32Array(o),r=new Float32Array(o*3);n.setAttribute("aHeight",new R(s,1)),n.setAttribute("aNeonColor",new R(r,3)),this.meshA=new K(n,i.clone(),o),this.meshA.frustumCulled=!1,this.mats.push(this.meshA.material);const a=new Le(.45,.55,1,10),f=new Float32Array(o),u=new Float32Array(o*3);a.setAttribute("aHeight",new R(f,1)),a.setAttribute("aNeonColor",new R(u,3)),this.meshB=new K(a,i.clone(),o),this.meshB.frustumCulled=!1,this.mats.push(this.meshB.material);const p=new we(1,.4,1),w=new Float32Array(o),m=new Float32Array(o*3);p.setAttribute("aHeight",new R(w,1)),p.setAttribute("aNeonColor",new R(m,3)),this.meshC=new K(p,i.clone(),o),this.meshC.frustumCulled=!1,this.mats.push(this.meshC.material);const C=new ye,S=new l,v=new l,y=new be;let x=0,b=0,h=0;for(let g=0;g<E;g++)for(let P=0;P<E;P++){const I=g*J-ne,G=P*J-ne;if(g%5===0||P%5===0||g%2===0&&P%2===0&&Math.random()<.25)continue;const z=g/E*4-2,ce=P/E*4-2,nt=Fe(z,ce,5),it=Math.sqrt(z*z+ce*ce)/3,st=Math.max(.18,1-it*.6),B=Math.max(8,(22+nt*170)*st)+A(4,28),ke=A(H*.42,H*.9),Me=A(H*.42,H*.9),at=$t(g,P),L=Q[at],Ie=Math.random();if(Ie<.65)s[x]=B,r[x*3]=L.r,r[x*3+1]=L.g,r[x*3+2]=L.b,S.set(I,B/2,G),v.set(ke,B,Me),C.compose(S,y,v),this.meshA.setMatrixAt(x,C),x++;else if(Ie<.82){const W=A(H*.18,H*.32);f[b]=B,u[b*3]=L.r,u[b*3+1]=L.g,u[b*3+2]=L.b,S.set(I+A(-3,3),B/2,G+A(-3,3)),v.set(W*2,B,W*2),C.compose(S,y,v),this.meshB.setMatrixAt(b,C),b++}else{const W=Math.max(6,B*.35);w[h]=W,m[h*3]=L.r,m[h*3+1]=L.g,m[h*3+2]=L.b,S.set(I,W/2,G),v.set(ke*1.4,W,Me*1.4),C.compose(S,y,v),this.meshC.setMatrixAt(h,C),h++}}this.meshA.count=x,this.meshB.count=b,this.meshC.count=h;for(const g of[this.meshA,this.meshB,this.meshC]){g.instanceMatrix.needsUpdate=!0;const P=g.geometry;P.getAttribute("aHeight").needsUpdate=!0,P.getAttribute("aNeonColor").needsUpdate=!0,e.add(g)}}addAntennas(e){const o=new Le(.1,.1,1,4),i=new _({color:16716083}),n=new K(o,i,400);n.frustumCulled=!1;const s=new ye,r=new l,a=new l,f=new be;let u=0;for(let p=0;p<400;p++){const w=Ue(0,E-1),m=Ue(0,E-1),C=w*J-ne,S=m*J-ne,v=w/E*4-2,y=m/E*4-2,x=Math.max(.18,1-Math.sqrt(v*v+y*y)/3*.6),b=Math.max(8,(22+Fe(v,y,5)*170)*x)+20,h=A(8,30);r.set(C+A(-3,3),b+h/2,S+A(-3,3)),a.set(1,h,1),s.compose(r,f,a),n.setMatrixAt(u++,s)}n.count=u,n.instanceMatrix.needsUpdate=!0,e.add(n)}addNeonSigns(e,o){o.forEach(({text:i,pos:n,color:s})=>{const r=document.createElement("canvas");r.width=256,r.height=64;const a=r.getContext("2d");a.clearRect(0,0,256,64),a.fillStyle=s+"22",a.fillRect(0,0,256,64),a.strokeStyle=s,a.lineWidth=2,a.strokeRect(2,2,252,60),a.fillStyle=s,a.font="bold 22px monospace",a.textAlign="center",a.fillText(i,128,40);const f=new qe(r),u=new re(18,4.5),p=new _({map:f,transparent:!0,side:Xe,depthWrite:!1}),w=new ee(u,p);w.position.copy(n),e.add(w)})}update(e){for(const o of this.mats)o.uniforms.uTime.value=e}}class Xt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const o=new re(1200,1200,1,1);return this.mat=new te({vertexShader:Ut,fragmentShader:Dt,uniforms:{uTime:{value:0},uDistrictNeon:{value:new d(62975)},uRainIntensity:{value:1}}}),this.mesh=new ee(o,this.mat),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=0,e.add(this.mesh),this.mesh}update(e){this.mat.uniforms.uTime.value=e}setDistrictNeon(e){this.mat.uniforms.uDistrictNeon.value.copy(e)}setRainIntensity(e){this.mat.uniforms.uRainIntensity.value=e}}class Yt{constructor(){c(this,"points");c(this,"count",8e3)}create(e){const o=new Float32Array(this.count*3),i=new Float32Array(this.count),n=new Float32Array(this.count);for(let a=0;a<this.count;a++)o[a*3]=A(-300,300),o[a*3+1]=A(-60,60),o[a*3+2]=A(-300,300),i[a]=A(.3,1),n[a]=Math.random();const s=new Ye;s.setAttribute("position",new se(o,3)),s.setAttribute("aSpeed",new se(i,1)),s.setAttribute("aOffset",new se(n,1));const r=new te({vertexShader:Ot,fragmentShader:Gt,uniforms:{uTime:{value:0}},transparent:!0,blending:Z,depthWrite:!1});this.points=new Ke(s,r),e.add(this.points)}update(e,o){const i=this.points.material;i.uniforms.uTime.value=e,o&&(this.points.position.x=o.x,this.points.position.z=o.z)}}class Kt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const o=new ct(2e3,32,16);this.mat=new te({vertexShader:zt,fragmentShader:Bt,uniforms:{uTime:{value:0},uZenithColor:{value:new d(132104)},uHorizonColor:{value:new d(1706e3)},uDistrictNeon:{value:new d(62975)}},side:dt,depthWrite:!1}),this.mesh=new ee(o,this.mat),this.mesh.renderOrder=-1,e.add(this.mesh)}update(e,o,i){this.mesh.position.copy(o),this.mat.uniforms.uTime.value=e,i&&this.mat.uniforms.uDistrictNeon.value.copy(i)}setDistrictColors(e,o){this.mat.uniforms.uHorizonColor.value.copy(e),this.mat.uniforms.uDistrictNeon.value.copy(o)}}function jt(t){let e=t;return()=>{e|=0,e=e+1831565813|0;let o=Math.imul(e^e>>>15,1|e);return o=o+Math.imul(o^o>>>7,61|o)^o,((o^o>>>14)>>>0)/4294967296}}const De=[new d(16720384),new d(61183),new d(22015),new d(16711884),new d(65382),new d(16737792),new d(11141375),new d(16770626)],Ce=32,je=16,Jt=6,Se=je+Jt,Oe=Ce/2*Se;class Zt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const i=new re(5,1.4),n=new Float32Array(150*3),s=new Float32Array(150),r=new Float32Array(150);i.setAttribute("aColor",new R(n,3)),i.setAttribute("aFlickerSeed",new R(s,1)),i.setAttribute("aPulseMode",new R(r,1)),this.mat=new te({vertexShader:Ht,fragmentShader:Wt,uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,side:Xe,blending:Z}),this.mesh=new K(i,this.mat,150),this.mesh.frustumCulled=!1;const a=jt(42),f=new ye,u=new l,p=new be,w=new l(1,1,1);let m=0;for(let C=0;C<Ce&&m<150;C++)for(let S=0;S<Ce&&m<150;S++){if(C%5===0||S%5===0||a()>.1)continue;const v=C*Se-Oe,y=S*Se-Oe,x=6+a()*12,b=Math.floor(a()*4),h=je*.5+.3;let g=v,P=y,I=0;b===0?(P=y+h,I=0):b===1?(P=y-h,I=Math.PI):b===2?(g=v+h,I=Math.PI*.5):(g=v-h,I=-Math.PI*.5),u.set(g,x,P),p.setFromEuler(new ut(0,I,0)),f.compose(u,p,w),this.mesh.setMatrixAt(m,f);const G=De[Math.floor(a()*De.length)];n[m*3]=G.r,n[m*3+1]=G.g,n[m*3+2]=G.b,s[m]=a();const z=a();r[m]=z<.6?0:z<.85?1:z<.95?2:3,m++}this.mesh.count=m,this.mesh.instanceMatrix.needsUpdate=!0,i.getAttribute("aColor").needsUpdate=!0,i.getAttribute("aFlickerSeed").needsUpdate=!0,i.getAttribute("aPulseMode").needsUpdate=!0,e.add(this.mesh)}update(e){this.mat.uniforms.uTime.value=e}}const Qt=`
...
`;class eo extends Lt{constructor(e=.45){super("LensStreakEffect",Qt,{uniforms:new Map([["uIntensity",new ht(e)]])})}}class to{constructor(){c(this,"composer");c(this,"glitch");c(this,"glitchTimeout",0)}setup(e,o,i){this.composer=new xt(e);const n=new Pt(o,i),s=new At({blendFunction:de.ADD,luminanceThreshold:.25,luminanceSmoothing:.4,intensity:2.4,radius:.6}),r=new eo(.45),a=new Tt({offset:new j(.0018,.0012),radialModulation:!0,modulationOffset:.5}),f=new Et({eskil:!1,offset:.35,darkness:.75}),u=new kt({blendFunction:de.OVERLAY,premultiply:!0});u.blendMode.opacity.value=.04;const p=new Mt({blendFunction:de.OVERLAY,density:1.4});return p.blendMode.opacity.value=.07,this.glitch=new It({delay:new j(99999,99999),duration:new j(.15,.35),strength:new j(.15,.4),columns:.04,ratio:.85}),this.composer.addPass(n),this.composer.addPass(new ue(i,s,r)),this.composer.addPass(new ue(i,a,p,f,u)),this.composer.addPass(new ue(i,this.glitch)),this.composer}triggerGlitch(){this.glitch.delay.set(0,.05),clearTimeout(this.glitchTimeout),this.glitchTimeout=window.setTimeout(()=>{this.glitch.delay.set(99999,99999)},600)}resize(e,o){this.composer.setSize(e,o)}render(){this.composer.render()}}const k=[{pos:new l(0,180,220),look:new l(0,0,0),label:"HERO",t:0},{pos:new l(-40,12,110),look:new l(-20,20,60),label:"ABOUT",t:0},{pos:new l(-80,-8,55),look:new l(-80,-8,20),label:"PS3 GPU",t:0},{pos:new l(-75,30,-25),look:new l(-75,0,-25),label:"CPUonGPU",t:0},{pos:new l(-30,10,-60),look:new l(0,20,-90),label:"GPU Stream",t:0},{pos:new l(20,35,-80),look:new l(40,25,-110),label:"Selkies",t:0},{pos:new l(80,55,-70),look:new l(100,35,-100),label:"Oris AI",t:0},{pos:new l(110,40,0),look:new l(90,22,-20),label:"VajraGrid",t:0},{pos:new l(100,20,70),look:new l(70,14,50),label:"VidyaMitra",t:0},{pos:new l(50,16,100),look:new l(20,12,80),label:"Netflip",t:0},{pos:new l(10,22,90),look:new l(-20,16,70),label:"Arena",t:0},{pos:new l(-30,60,70),look:new l(-10,40,40),label:"Hackathon",t:0},{pos:new l(-60,8,30),look:new l(-40,8,0),label:"SKILLS",t:0},{pos:new l(0,120,160),look:new l(0,0,0),label:"CONTACT",t:0}],oo=1600;class no{constructor(e){c(this,"camera");c(this,"posSpline");c(this,"lookSpline");c(this,"t",0);c(this,"currentSection",0);c(this,"mouseX",0);c(this,"mouseY",0);c(this,"_pos",new l);c(this,"_look",new l);c(this,"_ahead",new l);c(this,"onSectionChange");c(this,"_lastFiredSection",0);this.camera=e,this.buildSpline(),this.init()}buildSpline(){const e=k.map(n=>n.pos.clone()),o=k.map(n=>n.look.clone());this.posSpline=new Re(e,!1,"catmullrom",.5),this.lookSpline=new Re(o,!1,"catmullrom",.5);const i=k.length;k.forEach((n,s)=>{n.t=s/(i-1)}),this.t=0,this.posSpline.getPoint(0,this._pos),this.lookSpline.getPoint(0,this._look),this.camera.position.copy(this._pos),this.camera.lookAt(this._look)}init(){window.addEventListener("mousemove",i=>{this.mouseX=(i.clientX/window.innerWidth-.5)*2,this.mouseY=(i.clientY/window.innerHeight-.5)*2});let e=!1;window.addEventListener("wheel",i=>{if(e)return;e=!0;const n=i.deltaY>0?1:-1;this.goTo(this.currentSection+n),setTimeout(()=>{e=!1},oo)},{passive:!0});let o=0;window.addEventListener("touchstart",i=>{o=i.touches[0].clientY}),window.addEventListener("touchend",i=>{const n=o-i.changedTouches[0].clientY;Math.abs(n)>40&&this.goTo(this.currentSection+(n>0?1:-1))}),window.addEventListener("keydown",i=>{(i.key==="ArrowDown"||i.key==="ArrowRight")&&this.goTo(this.currentSection+1),(i.key==="ArrowUp"||i.key==="ArrowLeft")&&this.goTo(this.currentSection-1)})}goTo(e){if(e=Math.max(0,Math.min(k.length-1,e)),e===this.currentSection)return;const o=this.currentSection;this.currentSection=e;const i=k[e].t,s=.6+Math.abs(i-this.t)*5;V.killTweensOf(this),V.to(this,{t:i,duration:s,ease:"power2.inOut",onUpdate:()=>this._fireCrossings(o,e),onComplete:()=>{var r;this._lastFiredSection=e,(r=this.onSectionChange)==null||r.call(this,e),this._updateUI(e)}}),this._updateUI(e)}_fireCrossings(e,o){const i=o>e?1:-1;k.forEach((n,s)=>{var a;(i>0?this.t>=n.t&&s>this._lastFiredSection&&s<=o:this.t<=n.t&&s<this._lastFiredSection&&s>=o)&&(this._lastFiredSection=s,(a=this.onSectionChange)==null||a.call(this,s),this._updateUI(s))})}update(e){this.posSpline.getPoint(this.t,this._pos),this.camera.position.copy(this._pos);const o=Math.min(1,this.t+.015);this.posSpline.getPoint(o,this._ahead),this.lookSpline.getPoint(this.t,this._look);const i=this._look.x*.8+this._ahead.x*.2+this.mouseX*5,n=this._look.y*.8+this._ahead.y*.2-this.mouseY*3,s=this._look.z*.8+this._ahead.z*.2;this.camera.lookAt(i,n,s)}_updateUI(e){document.querySelectorAll(".nav-dot").forEach((i,n)=>i.classList.toggle("active",n===e));const o=document.getElementById("progress-bar");o&&(o.style.height=e/(k.length-1)*100+"%")}getCurrentSection(){return this.currentSection}}const Je=[{id:"ps3-gpu",title:"PS3 Cell GPU Emulator",subtitle:"Systems / Emulation",desc:"Full emulation of the Cell Broadband Engine's SPU pipeline in WebGL. 6 SPU cores, PPE scheduler, DMA bus — running real PS3 shaders in the browser at 200 GIPS.",tags:["C++","WebGL","GLSL","Cell BE","Emulation"],url:"https://github.com/aerosane",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"⬡"},{id:"cpuongpu",title:"CPUonGPU",subtitle:"Architecture Research",desc:"Runs a full x86 CPU simulation entirely on GPU compute shaders. Register file, ALU, cache hierarchy — all in GLSL. JIT-compiled x86 → SPIR-V at runtime.",tags:["GLSL","Compute Shaders","x86","JIT","SPIR-V"],url:"https://github.com/aerosane",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"⬢"},{id:"gpu-streaming",title:"GPU Streaming Pipeline",subtitle:"NvFBC + NVENC",desc:"Sub-frame-latency game streaming via NvFBC capture → NVENC H265/AV1 encode → WebRTC TURN relay. <1 frame E2E latency. Deployed on GitHub Codespace GPU.",tags:["NVENC","NvFBC","WebRTC","Rust","H265"],url:"https://github.com/Imperialorg/codespace",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"▶"},{id:"selkies-rust",title:"Selkies-Rust",subtitle:"Python→Rust Port",desc:"Complete rewrite of the Selkies WebRTC game streaming stack from Python into Rust. 6 crates: pipeline, signaling, input, encoding, metrics, CLI.",tags:["Rust","WebRTC","GStreamer","Tokio","GSAP"],url:"https://github.com/Imperialorg/codespace",neonColor:"#ff6b1a",district:"SYSTEMS CORRIDOR",icon:"⚙"},{id:"oris-ai",title:"Oris — AI SRE",subtitle:"🏆 Runner-up · TechSynapse 2026",desc:"Autonomous Site Reliability Engineer: ingests production logs, PII-masks with Presidio, infers root cause via Gemini 2.0, opens GitHub PRs with fixes. Zero human touch.",tags:["Python","Gemini 2.0","Presidio","LangChain","FastAPI"],url:"https://github.com/aerosane",neonColor:"#ff00aa",district:"AI DISTRICT",icon:"◈"},{id:"vajragrid",title:"VajraGrid",subtitle:"🇮🇳 India Innovates 2026 · Bharat Mandapam",desc:"AI-hardened power grid security: detects SCADA cyberattacks in 16s, 4-layer ML defense stack, adversarial training. Exhibited nationally at Bharat Mandapam.",tags:["Python","PyTorch","SCADA","Adversarial ML","GridSec"],url:"https://github.com/aerosane",neonColor:"#ff00aa",district:"AI DISTRICT",icon:"⚡"},{id:"vidyamitra",title:"VidyaMitra",subtitle:"IISER JEE Prep",desc:"AI tutor for JEE aspirants: adaptive quiz engine, LaTeX equation rendering, spaced repetition. Covers Physics, Chemistry, Math with difficulty auto-calibration.",tags:["TypeScript","React","LaTeX","OpenAI","Supabase"],url:"https://github.com/aerosane",neonColor:"#00ff88",district:"EDTECH ZONE",icon:"⬟"},{id:"netflip",title:"Netflip VOD",subtitle:"Full-Stack Streaming",desc:"Netflix-clone with HLS adaptive streaming, Azure Blob CDN, Fastly edge cache, WebSocket live chat, OAuth2, recommendation engine. 1080p adaptive bitrate.",tags:["Next.js","HLS","Azure","Fastly","PostgreSQL"],url:"https://github.com/aerosane",neonColor:"#7b2fff",district:"WEB DISTRICT",icon:"▨"},{id:"coding-arena",title:"Coding Arena",subtitle:"Competitive Judging Platform",desc:"Online judge with isolated Docker execution, multi-language support, real-time leaderboard, plagiarism detection via AST similarity. 200ms median judge latency.",tags:["Go","Docker","Redis","React","WebSocket"],url:"https://github.com/aerosane",neonColor:"#7b2fff",district:"WEB DISTRICT",icon:"{ }"},{id:"hackathon",title:"Hackathon Wins",subtitle:"Hall of Fame",desc:"🏆 Runner-up at TechSynapse 2026 (Oris AI SRE). 🇮🇳 National exhibition at India Innovates 2026, Bharat Mandapam, New Delhi (VajraGrid). 1st year, two nationals.",tags:["Oris AI","VajraGrid","TechSynapse","India Innovates"],url:"https://github.com/aerosane",neonColor:"#ffe642",district:"HALL OF FAME",icon:"🏆"}],io={Languages:["C++","Rust","Python","TypeScript","Go","GLSL/HLSL"],Systems:["WebRTC","WebGL/WebGPU","NVENC/NvFBC","Docker","Linux"],"AI/ML":["PyTorch","Gemini API","LangChain","Presidio","HuggingFace"],Web:["React","Next.js","Vite","Node.js","PostgreSQL","Redis"],Tools:["Git","GitHub Actions","Azure","GStreamer","Tokio"]};class so{constructor(){c(this,"group",new xe);c(this,"hoverTargets",[]);c(this,"visible",!1);c(this,"visibleValue",0)}enter(){this.group.visible=!0,this.visible=!0,V.killTweensOf(this),V.to(this,{visibleValue:1,duration:1.4,ease:"power2.out",onUpdate:()=>this.setVisible(this.visibleValue)})}exit(){this.visible=!1,V.killTweensOf(this),V.to(this,{visibleValue:0,duration:.8,ease:"power2.in",onUpdate:()=>this.setVisible(this.visibleValue),onComplete:()=>{this.group.visible=!1}})}setVisible(e){}dispose(){this.group.traverse(e=>{e.geometry&&e.geometry.dispose()})}}let U=null;function ao(){return U||(U=document.createElement("div"),U.id="env-detail-panel",Object.assign(U.style,{position:"fixed",top:"50%",left:"50%",transform:"translate(-50%, -50%) scale(0.92)",background:"rgba(4,6,20,0.92)",border:"1px solid var(--neon, #00f5ff)",boxShadow:"0 0 32px var(--neon, #00f5ff)44",padding:"28px 36px",maxWidth:"480px",width:"90vw",zIndex:"9999",fontFamily:"monospace",color:"#e8f4ff",opacity:"0",pointerEvents:"none",transition:"opacity 0.3s, transform 0.3s",borderRadius:"4px"}),document.body.appendChild(U),U)}function ro(t){var o;const e=ao();e.style.setProperty("--neon",t.neonColor),e.style.borderColor=t.neonColor+"88",e.style.boxShadow=`0 0 40px ${t.neonColor}33`,e.innerHTML=`
  ...
  `,(o=e.querySelector("#env-panel-close"))==null||o.addEventListener("click",i=>{i.stopPropagation(),Ze()}),e.style.pointerEvents="all",e.style.opacity="1",e.style.transform="translate(-50%, -50%) scale(1)"}function Ze(){const t=U;t&&(t.style.opacity="0",t.style.transform="translate(-50%, -50%) scale(0.92)",t.style.pointerEvents="none")}function lo(t){const i=document.createElement("canvas");i.width=900,i.height=400;const n=i.getContext("2d"),s=t.neonColor;n.clearRect(0,0,900,400),n.fillStyle="rgba(4,6,20,0.82)",n.fillRect(0,0,900,400),n.fillStyle=s,n.shadowColor=s,n.shadowBlur=22,n.fillRect(0,0,6,400),n.shadowBlur=0,n.font="11px monospace",n.fillStyle=s+"88",n.textAlign="left",n.fillText(t.district.toUpperCase(),30,34);const r=t.title.length>16?52:72;n.font=`bold ${r}px monospace`,n.shadowColor=s,n.shadowBlur=48,n.fillStyle="#ffffff",n.fillText(t.title,30,82+(72-r)),n.shadowBlur=24,n.fillStyle=s+"cc",n.fillText(t.title,30,82+(72-r)),n.shadowBlur=0,n.font="20px monospace",n.fillStyle="rgba(255,255,255,0.55)",n.fillText(t.subtitle,30,152),n.strokeStyle=s+"33",n.lineWidth=1,n.beginPath(),n.moveTo(30,174),n.lineTo(870,174),n.stroke(),n.font="bold 15px monospace";let a=30;for(const f of t.tags.slice(0,4)){const u=n.measureText(f).width+24;n.strokeStyle=s+"55",n.lineWidth=1,n.strokeRect(a,190,u,30),n.fillStyle=s+"dd",n.fillText(f,a+12,210),a+=u+10}return n.font="13px monospace",n.fillStyle=s+"66",n.fillText("[ CLICK TO VIEW PROJECT ]",30,380),new qe(i)}function F(t,e,o,i,n){const s=new ee(new we(t,e,o),n);return s.position.copy(i),s.frustumCulled=!1,s}class co extends so{constructor(o,i,n){super();c(this,"projIdx");c(this,"panelPos");c(this,"camPos");c(this,"fadeMats",[]);c(this,"particleMat");this.projIdx=o,this.panelPos=i,this.camPos=n}create(o){o.add(this.group);const i=Je[this.projIdx],n=new d(i.neonColor),s=new xe;s.position.copy(this.panelPos),s.lookAt(this.camPos),this.group.add(s);const r=(h,g)=>(h.opacity=0,this.fadeMats.push([h,g]),h),a=r(new _({map:lo(i),transparent:!0,depthWrite:!1,side:ft,alphaTest:.01}),1),f=new ee(new re(40,18),a);f.frustumCulled=!1,f.userData.isLabel=!0,f.userData.onClick=()=>ro(i),s.add(f);const u=r(new _({color:n,transparent:!0,blending:Z,depthWrite:!1}),.85);s.add(F(41,.5,.4,new l(0,9.25,.1),u)),s.add(F(41,.5,.4,new l(0,-9.25,.1),u)),s.add(F(.5,19,.4,new l(-20.25,0,.1),u)),s.add(F(.5,19,.4,new l(20.25,0,.1),u));const p=14,w=r(new _({color:2763326,transparent:!0}),1),m=new l(-13,-9-p/2,0),C=new l(13,-9-p/2,0);s.add(F(.9,p,.9,m,w)),s.add(F(.9,p,.9,C,w)),s.add(F(27,.7,.9,new l(0,-9-p+.4,0),w));const S=r(new _({color:n,transparent:!0,blending:Z,depthWrite:!1}),.5);s.add(F(41,.3,.1,new l(0,9.25,.2),S));const v=60,y=new Float32Array(v*3);for(let h=0;h<v;h++)y[h*3]=this.panelPos.x+(Math.random()-.5)*60,y[h*3+1]=this.panelPos.y+(Math.random()-.5)*35,y[h*3+2]=this.panelPos.z+(Math.random()-.5)*60;const x=new Ye;x.setAttribute("position",new se(y,3)),this.particleMat=new pt({size:.4,color:n,transparent:!0,opacity:0,blending:Z,sizeAttenuation:!0});const b=new Ke(x,this.particleMat);b.frustumCulled=!1,this.group.add(b)}update(o){}setVisible(o){for(const[i,n]of this.fadeMats)i.opacity=o*n;this.particleMat&&(this.particleMat.opacity=o*.45)}onHover(){}}const uo=[[2,0],[3,1],[4,2],[5,3],[6,4],[7,5],[8,6],[9,7],[10,8],[11,9]];class ho{constructor(e,o){c(this,"envs",new Map);c(this,"activeEnv",null);c(this,"activeIdx",-1);for(const[i,n]of uo){const s=k[i],r=new co(n,s.look.clone(),s.pos.clone());r.create(e),r.group.visible=!1,this.envs.set(i,r)}}onSection(e){if(e===this.activeIdx)return;this.activeIdx=e,this.activeEnv&&(this.activeEnv.exit(),this.activeEnv=null);const o=this.envs.get(e);o&&(this.activeEnv=o,o.enter())}update(e){this.activeEnv&&this.activeEnv.update(e)}}const fo=document.getElementById("scene-canvas"),q=new mt({canvas:fo,antialias:!0,alpha:!1,powerPreference:"high-performance"});q.setPixelRatio(Math.min(devicePixelRatio,2));q.setSize(innerWidth,innerHeight);q.toneMapping=vt;q.toneMappingExposure=.95;const T=new gt;T.background=new d(131602);T.fog=new wt(197400,.003);const O=new yt(60,innerWidth/innerHeight,.5,1200),le=new to;le.setup(q,T,O);const Pe=new Kt;Pe.create(T);const D=new qt;D.generate(T);D.addAntennas(T);const po=Je.map((t,e)=>{const o=k[e+2];return{text:t.district,pos:new l(o.pos.x+12,80,o.pos.z-18),color:t.neonColor}});D.addNeonSigns(T,po);const Qe=new Zt;Qe.create(T);const Ae=new Xt;Ae.create(T);const et=new Yt;et.create(T);const mo=new bt(128,0,.4);T.add(mo);const Te=new xe;T.add(Te);var _e,Ve;(Ve=(_e=D.cityGroup)==null?void 0:_e.children)==null||Ve.forEach(t=>Te.add(t));const tt=new ho(T,Te),ae=new d(62975);function vo(t){const e=Math.min(t,Q.length-1);ae.copy(Q[e]),Ae.setDistrictNeon(ae),Pe.update(0,O.position,ae)}const go=[["NEON DISTRICT","A cyberpunk portfolio"],["ABOUT","Who is behind this"],["PS3 CELL GPU","PS3 SPU emulator in WebGL"],["CPUonGPU","x86 CPU running on GPU"],["GPU STREAMING","Sub-frame game streaming"],["SELKIES RUST","WebRTC stack rebuilt in Rust"],["ORIS AI","Autonomous SRE agent"],["VAJRAGRID","AI power grid security"],["VIDYAMITRA","Adaptive JEE AI tutor"],["NETFLIP","HLS streaming platform"],["ARENA OJ","Online judge platform"],["HACKATHON","Competition highlights"],["TECH STACK","Tools and languages"],["CONTACT","Get in touch"]],$=document.createElement("div");$.id="section-banner";Object.assign($.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%)",textAlign:"center",pointerEvents:"none",zIndex:"50",opacity:"0",transition:"opacity 0.4s",background:"rgba(0,0,8,0.65)",padding:"10px 28px",borderTop:"1px solid currentColor"});document.body.appendChild($);function wo(t){const[e,o]=go[t]??["",""],i=Q[t]?"#"+Q[t].getHexString():"#00f5ff";$.style.color=i,$.innerHTML=`
