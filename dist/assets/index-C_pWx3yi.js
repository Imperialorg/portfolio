...
`,E=32,H=16,_t=6,j=H+_t,ne=E/2*j,fe={color:new p(197400),near:100,far:500},Q=[new p(62975),new p(62975),new p(16711850),new p(16711850),new p(16739098),new p(8073215),new p(8073215),new p(65416),new p(65416),new p(16770626)];function Vt(){return new te({vertexShader:Nt,fragmentShader:Ft,uniforms:{uTime:{value:0},uFogColor:{value:fe.color},uFogNear:{value:fe.near},uFogFar:{value:fe.far}}})}function $t(t,e){const o=t/E,i=e/E;return o<.35&&i<.35?0:o<.65&&i<.35?1:o>=.65&&i<.35?2:o<.35&&i<.65?3:o>=.65&&i<.65?4:o<.35&&i>=.65?5:o<.65&&i>=.65?6:o>=.65&&i>=.65?7:i>.45&&i<.55?8:9}class qt{constructor(){c(this,"meshA");c(this,"meshB");c(this,"meshC");c(this,"mats",[])}generate(e){const o=E*E,i=Vt();this.mats.push(i);const n=new we(1,1,1),s=new Float32Array(o),l=new Float32Array(o*3);n.setAttribute("aHeight",new R(s,1)),n.setAttribute("aNeonColor",new R(l,3)),this.meshA=new K(n,i.clone(),o),this.meshA.frustumCulled=!1,this.mats.push(this.meshA.material);const a=new Le(.45,.55,1,10),v=new Float32Array(o),w=new Float32Array(o*3);a.setAttribute("aHeight",new R(v,1)),a.setAttribute("aNeonColor",new R(w,3)),this.meshB=new K(a,i.clone(),o),this.meshB.frustumCulled=!1,this.mats.push(this.meshB.material);const h=new we(1,.4,1),f=new Float32Array(o),d=new Float32Array(o*3);h.setAttribute("aHeight",new R(f,1)),h.setAttribute("aNeonColor",new R(d,3)),this.meshC=new K(h,i.clone(),o),this.meshC.frustumCulled=!1,this.mats.push(this.meshC.material);const u=new ye,m=new r,C=new r,T=new be;let x=0,y=0,b=0;for(let S=0;S<E;S++)for(let g=0;g<E;g++){const M=S*j-ne,O=g*j-ne;if(S%5===0||g%5===0||S%2===0&&g%2===0&&Math.random()<.25)continue;const z=S/E*4-2,ce=g/E*4-2,nt=Fe(z,ce,5),it=Math.sqrt(z*z+ce*ce)/3,st=Math.max(.18,1-it*.6),B=Math.max(8,(22+nt*170)*st)+P(4,28),ke=P(H*.42,H*.9),Me=P(H*.42,H*.9),at=$t(S,g),L=Q[at],Ie=Math.random();if(Ie<.65)s[x]=B,l[x*3]=L.r,l[x*3+1]=L.g,l[x*3+2]=L.b,m.set(M,B/2,O),C.set(ke,B,Me),u.compose(m,T,C),this.meshA.setMatrixAt(x,u),x++;else if(Ie<.82){const W=P(H*.18,H*.32);v[y]=B,w[y*3]=L.r,w[y*3+1]=L.g,w[y*3+2]=L.b,m.set(M+P(-3,3),B/2,O+P(-3,3)),C.set(W*2,B,W*2),u.compose(m,T,C),this.meshB.setMatrixAt(y,u),y++}else{const W=Math.max(6,B*.35);f[b]=W,d[b*3]=L.r,d[b*3+1]=L.g,d[b*3+2]=L.b,m.set(M,W/2,O),C.set(ke*1.4,W,Me*1.4),u.compose(m,T,C),this.meshC.setMatrixAt(b,u),b++}}this.meshA.count=x,this.meshB.count=y,this.meshC.count=b;for(const S of[this.meshA,this.meshB,this.meshC]){S.instanceMatrix.needsUpdate=!0;const g=S.geometry;g.getAttribute("aHeight").needsUpdate=!0,g.getAttribute("aNeonColor").needsUpdate=!0,e.add(S)}}addAntennas(e){const o=new Le(.1,.1,1,4),i=new _({color:16716083}),n=new K(o,i,400);n.frustumCulled=!1;const s=new ye,l=new r,a=new r,v=new be;let w=0;for(let h=0;h<400;h++){const f=Ue(0,E-1),d=Ue(0,E-1),u=f*j-ne,m=d*j-ne,C=f/E*4-2,T=d/E*4-2,x=Math.max(.18,1-Math.sqrt(C*C+T*T)/3*.6),y=Math.max(8,(22+Fe(C,T,5)*170)*x)+20,b=P(8,30);l.set(u+P(-3,3),y+b/2,m+P(-3,3)),a.set(1,b,1),s.compose(l,v,a),n.setMatrixAt(w++,s)}n.count=w,n.instanceMatrix.needsUpdate=!0,e.add(n)}addNeonSigns(e,o){o.forEach(({text:i,pos:n,color:s})=>{const l=document.createElement("canvas");l.width=256,l.height=64;const a=l.getContext("2d");a.clearRect(0,0,256,64),a.fillStyle=s+"22",a.fillRect(0,0,256,64),a.strokeStyle=s,a.lineWidth=2,a.strokeRect(2,2,252,60),a.fillStyle=s,a.font="bold 22px monospace",a.textAlign="center",a.fillText(i,128,40);const v=new qe(l),w=new re(18,4.5),h=new _({map:v,transparent:!0,side:Xe,depthWrite:!1}),f=new ee(w,h);f.position.copy(n),e.add(f)})}update(e){for(const o of this.mats)o.uniforms.uTime.value=e}}class Xt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const o=new re(1200,1200,1,1);return this.mat=new te({vertexShader:Ut,fragmentShader:Dt,uniforms:{uTime:{value:0},uDistrictNeon:{value:new p(62975)},uRainIntensity:{value:1}}}),this.mesh=new ee(o,this.mat),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=0,e.add(this.mesh),this.mesh}update(e){this.mat.uniforms.uTime.value=e}setDistrictNeon(e){this.mat.uniforms.uDistrictNeon.value.copy(e)}setRainIntensity(e){this.mat.uniforms.uRainIntensity.value=e}}class Yt{constructor(){c(this,"points");c(this,"count",8e3)}create(e){const o=new Float32Array(this.count*3),i=new Float32Array(this.count),n=new Float32Array(this.count);for(let a=0;a<this.count;a++)o[a*3]=P(-300,300),o[a*3+1]=P(-60,60),o[a*3+2]=P(-300,300),i[a]=P(.3,1),n[a]=Math.random();const s=new Ye;s.setAttribute("position",new se(o,3)),s.setAttribute("aSpeed",new se(i,1)),s.setAttribute("aOffset",new se(n,1));const l=new te({vertexShader:Gt,fragmentShader:Ot,uniforms:{uTime:{value:0}},transparent:!0,blending:Z,depthWrite:!1});this.points=new Ke(s,l),e.add(this.points)}update(e,o){const i=this.points.material;i.uniforms.uTime.value=e,o&&(this.points.position.x=o.x,this.points.position.z=o.z)}}class Kt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const o=new ct(2e3,32,16);this.mat=new te({vertexShader:zt,fragmentShader:Bt,uniforms:{uTime:{value:0},uZenithColor:{value:new p(132104)},uHorizonColor:{value:new p(1706e3)},uDistrictNeon:{value:new p(62975)}},side:dt,depthWrite:!1}),this.mesh=new ee(o,this.mat),this.mesh.renderOrder=-1,e.add(this.mesh)}update(e,o,i){this.mesh.position.copy(o),this.mat.uniforms.uTime.value=e,i&&this.mat.uniforms.uDistrictNeon.value.copy(i)}setDistrictColors(e,o){this.mat.uniforms.uHorizonColor.value.copy(e),this.mat.uniforms.uDistrictNeon.value.copy(o)}}function Jt(t){let e=t;return()=>{e|=0,e=e+1831565813|0;let o=Math.imul(e^e>>>15,1|e);return o=o+Math.imul(o^o>>>7,61|o)^o,((o^o>>>14)>>>0)/4294967296}}const De=[new p(16720384),new p(61183),new p(22015),new p(16711884),new p(65382),new p(16737792),new p(11141375),new p(16770626)],Se=32,Je=16,jt=6,Ce=Je+jt,Ge=Se/2*Ce;class Zt{constructor(){c(this,"mesh");c(this,"mat")}create(e){const i=new re(5,1.4),n=new Float32Array(150*3),s=new Float32Array(150),l=new Float32Array(150);i.setAttribute("aColor",new R(n,3)),i.setAttribute("aFlickerSeed",new R(s,1)),i.setAttribute("aPulseMode",new R(l,1)),this.mat=new te({vertexShader:Ht,fragmentShader:Wt,uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,side:Xe,blending:Z}),this.mesh=new K(i,this.mat,150),this.mesh.frustumCulled=!1;const a=Jt(42),v=new ye,w=new r,h=new be,f=new r(1,1,1);let d=0;for(let u=0;u<Se&&d<150;u++)for(let m=0;m<Se&&d<150;m++){if(u%5===0||m%5===0||a()>.1)continue;const C=u*Ce-Ge,T=m*Ce-Ge,x=6+a()*12,y=Math.floor(a()*4),b=Je*.5+.3;let S=C,g=T,M=0;y===0?(g=T+b,M=0):y===1?(g=T-b,M=Math.PI):y===2?(S=C+b,M=Math.PI*.5):(S=C-b,M=-Math.PI*.5),w.set(S,x,g),h.setFromEuler(new ut(0,M,0)),v.compose(w,h,f),this.mesh.setMatrixAt(d,v);const O=De[Math.floor(a()*De.length)];n[d*3]=O.r,n[d*3+1]=O.g,n[d*3+2]=O.b,s[d]=a();const z=a();l[d]=z<.6?0:z<.85?1:z<.95?2:3,d++}this.mesh.count=d,this.mesh.instanceMatrix.needsUpdate=!0,i.getAttribute("aColor").needsUpdate=!0,i.getAttribute("aFlickerSeed").needsUpdate=!0,i.getAttribute("aPulseMode").needsUpdate=!0,e.add(this.mesh)}update(e){this.mat.uniforms.uTime.value=e}}const Qt=`
...
`;class eo extends Lt{constructor(e=.45){super("LensStreakEffect",Qt,{uniforms:new Map([["uIntensity",new ht(e)]])})}}class to{constructor(){c(this,"composer");c(this,"glitch");c(this,"glitchTimeout",0)}setup(e,o,i){this.composer=new xt(e);const n=new Pt(o,i),s=new At({blendFunction:de.ADD,luminanceThreshold:.25,luminanceSmoothing:.4,intensity:2.4,radius:.6}),l=new eo(.45),a=new Tt({offset:new J(.0018,.0012),radialModulation:!0,modulationOffset:.5}),v=new Et({eskil:!1,offset:.35,darkness:.75}),w=new kt({blendFunction:de.OVERLAY,premultiply:!0});w.blendMode.opacity.value=.04;const h=new Mt({blendFunction:de.OVERLAY,density:1.4});return h.blendMode.opacity.value=.07,this.glitch=new It({delay:new J(99999,99999),duration:new J(.15,.35),strength:new J(.15,.4),columns:.04,ratio:.85}),this.composer.addPass(n),this.composer.addPass(new ue(i,s,l)),this.composer.addPass(new ue(i,a,h,v,w)),this.composer.addPass(new ue(i,this.glitch)),this.composer}triggerGlitch(){this.glitch.delay.set(0,.05),clearTimeout(this.glitchTimeout),this.glitchTimeout=window.setTimeout(()=>{this.glitch.delay.set(99999,99999)},600)}resize(e,o){this.composer.setSize(e,o)}render(){this.composer.render()}}const k=[{pos:new r(0,180,220),look:new r(0,0,0),label:"HERO",t:0},{pos:new r(-40,12,110),look:new r(-20,20,60),label:"ABOUT",t:0},{pos:new r(-80,58,48),look:new r(-80,58,20),label:"PS3 GPU",t:0},{pos:new r(-75,62,3),look:new r(-75,62,-25),label:"CPUonGPU",t:0},{pos:new r(-13,58,-62),look:new r(0,58,-90),label:"GPU Stream",t:0},{pos:new r(19,58,-82),look:new r(40,58,-110),label:"Selkies",t:0},{pos:new r(90,58,-71),look:new r(100,58,-100),label:"Oris AI",t:0},{pos:new r(101,58,8),look:new r(90,58,-20),label:"VajraGrid",t:0},{pos:new r(84,55,76),look:new r(70,55,50),label:"VidyaMitra",t:0},{pos:new r(34,55,106),look:new r(20,55,80),label:"Netflip",t:0},{pos:new r(-5,55,96),look:new r(-20,55,70),label:"Arena",t:0},{pos:new r(-20,62,67),look:new r(-10,62,40),label:"Hackathon",t:0},{pos:new r(-60,8,30),look:new r(-40,8,0),label:"SKILLS",t:0},{pos:new r(0,120,160),look:new r(0,0,0),label:"CONTACT",t:0}],oo=1600;class no{constructor(e){c(this,"camera");c(this,"posSpline");c(this,"lookSpline");c(this,"t",0);c(this,"currentSection",0);c(this,"mouseX",0);c(this,"mouseY",0);c(this,"_pos",new r);c(this,"_look",new r);c(this,"_ahead",new r);c(this,"onSectionChange");c(this,"_lastFiredSection",0);this.camera=e,this.buildSpline(),this.init()}buildSpline(){const e=k.map(n=>n.pos.clone()),o=k.map(n=>n.look.clone());this.posSpline=new Re(e,!1,"catmullrom",.5),this.lookSpline=new Re(o,!1,"catmullrom",.5);const i=k.length;k.forEach((n,s)=>{n.t=s/(i-1)}),this.t=0,this.posSpline.getPoint(0,this._pos),this.lookSpline.getPoint(0,this._look),this.camera.position.copy(this._pos),this.camera.lookAt(this._look)}init(){window.addEventListener("mousemove",i=>{this.mouseX=(i.clientX/window.innerWidth-.5)*2,this.mouseY=(i.clientY/window.innerHeight-.5)*2});let e=!1;window.addEventListener("wheel",i=>{if(e)return;e=!0;const n=i.deltaY>0?1:-1;this.goTo(this.currentSection+n),setTimeout(()=>{e=!1},oo)},{passive:!0});let o=0;window.addEventListener("touchstart",i=>{o=i.touches[0].clientY}),window.addEventListener("touchend",i=>{const n=o-i.changedTouches[0].clientY;Math.abs(n)>40&&this.goTo(this.currentSection+(n>0?1:-1))}),window.addEventListener("keydown",i=>{(i.key==="ArrowDown"||i.key==="ArrowRight")&&this.goTo(this.currentSection+1),(i.key==="ArrowUp"||i.key==="ArrowLeft")&&this.goTo(this.currentSection-1)})}goTo(e){if(e=Math.max(0,Math.min(k.length-1,e)),e===this.currentSection)return;const o=this.currentSection;this.currentSection=e;const i=k[e].t,s=.6+Math.abs(i-this.t)*5;V.killTweensOf(this),V.to(this,{t:i,duration:s,ease:"power2.inOut",onUpdate:()=>this._fireCrossings(o,e),onComplete:()=>{var l;this._lastFiredSection=e,(l=this.onSectionChange)==null||l.call(this,e),this._updateUI(e)}}),this._updateUI(e)}_fireCrossings(e,o){const i=o>e?1:-1;k.forEach((n,s)=>{var a;(i>0?this.t>=n.t&&s>this._lastFiredSection&&s<=o:this.t<=n.t&&s<this._lastFiredSection&&s>=o)&&(this._lastFiredSection=s,(a=this.onSectionChange)==null||a.call(this,s),this._updateUI(s))})}update(e){this.posSpline.getPoint(this.t,this._pos),this.camera.position.copy(this._pos);const o=Math.min(1,this.t+.015);this.posSpline.getPoint(o,this._ahead),this.lookSpline.getPoint(this.t,this._look);const i=this._look.x*.8+this._ahead.x*.2+this.mouseX*5,n=this._look.y*.8+this._ahead.y*.2-this.mouseY*3,s=this._look.z*.8+this._ahead.z*.2;this.camera.lookAt(i,n,s)}_updateUI(e){document.querySelectorAll(".nav-dot").forEach((i,n)=>i.classList.toggle("active",n===e));const o=document.getElementById("progress-bar");o&&(o.style.height=e/(k.length-1)*100+"%")}getCurrentSection(){return this.currentSection}}const je=[{id:"ps3-gpu",title:"PS3 Cell GPU Emulator",subtitle:"Systems / Emulation",desc:"Full emulation of the Cell Broadband Engine's SPU pipeline in WebGL. 6 SPU cores, PPE scheduler, DMA bus — running real PS3 shaders in the browser at 200 GIPS.",tags:["C++","WebGL","GLSL","Cell BE","Emulation"],url:"https://github.com/aerosane",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"⬡"},{id:"cpuongpu",title:"CPUonGPU",subtitle:"Architecture Research",desc:"Runs a full x86 CPU simulation entirely on GPU compute shaders. Register file, ALU, cache hierarchy — all in GLSL. JIT-compiled x86 → SPIR-V at runtime.",tags:["GLSL","Compute Shaders","x86","JIT","SPIR-V"],url:"https://github.com/aerosane",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"⬢"},{id:"gpu-streaming",title:"GPU Streaming Pipeline",subtitle:"NvFBC + NVENC",desc:"Sub-frame-latency game streaming via NvFBC capture → NVENC H265/AV1 encode → WebRTC TURN relay. <1 frame E2E latency. Deployed on GitHub Codespace GPU.",tags:["NVENC","NvFBC","WebRTC","Rust","H265"],url:"https://github.com/Imperialorg/codespace",neonColor:"#00f5ff",district:"GPU DISTRICT",icon:"▶"},{id:"selkies-rust",title:"Selkies-Rust",subtitle:"Python→Rust Port",desc:"Complete rewrite of the Selkies WebRTC game streaming stack from Python into Rust. 6 crates: pipeline, signaling, input, encoding, metrics, CLI.",tags:["Rust","WebRTC","GStreamer","Tokio","GSAP"],url:"https://github.com/Imperialorg/codespace",neonColor:"#ff6b1a",district:"SYSTEMS CORRIDOR",icon:"⚙"},{id:"oris-ai",title:"Oris — AI SRE",subtitle:"🏆 Runner-up · TechSynapse 2026",desc:"Autonomous Site Reliability Engineer: ingests production logs, PII-masks with Presidio, infers root cause via Gemini 2.0, opens GitHub PRs with fixes. Zero human touch.",tags:["Python","Gemini 2.0","Presidio","LangChain","FastAPI"],url:"https://github.com/aerosane",neonColor:"#ff00aa",district:"AI DISTRICT",icon:"◈"},{id:"vajragrid",title:"VajraGrid",subtitle:"🇮🇳 India Innovates 2026 · Bharat Mandapam",desc:"AI-hardened power grid security: detects SCADA cyberattacks in 16s, 4-layer ML defense stack, adversarial training. Exhibited nationally at Bharat Mandapam.",tags:["Python","PyTorch","SCADA","Adversarial ML","GridSec"],url:"https://github.com/aerosane",neonColor:"#ff00aa",district:"AI DISTRICT",icon:"⚡"},{id:"vidyamitra",title:"VidyaMitra",subtitle:"IISER JEE Prep",desc:"AI tutor for JEE aspirants: adaptive quiz engine, LaTeX equation rendering, spaced repetition. Covers Physics, Chemistry, Math with difficulty auto-calibration.",tags:["TypeScript","React","LaTeX","OpenAI","Supabase"],url:"https://github.com/aerosane",neonColor:"#00ff88",district:"EDTECH ZONE",icon:"⬟"},{id:"netflip",title:"Netflip VOD",subtitle:"Full-Stack Streaming",desc:"Netflix-clone with HLS adaptive streaming, Azure Blob CDN, Fastly edge cache, WebSocket live chat, OAuth2, recommendation engine. 1080p adaptive bitrate.",tags:["Next.js","HLS","Azure","Fastly","PostgreSQL"],url:"https://github.com/aerosane",neonColor:"#7b2fff",district:"WEB DISTRICT",icon:"▨"},{id:"coding-arena",title:"Coding Arena",subtitle:"Competitive Judging Platform",desc:"Online judge with isolated Docker execution, multi-language support, real-time leaderboard, plagiarism detection via AST similarity. 200ms median judge latency.",tags:["Go","Docker","Redis","React","WebSocket"],url:"https://github.com/aerosane",neonColor:"#7b2fff",district:"WEB DISTRICT",icon:"{ }"},{id:"hackathon",title:"Hackathon Wins",subtitle:"Hall of Fame",desc:"🏆 Runner-up at TechSynapse 2026 (Oris AI SRE). 🇮🇳 National exhibition at India Innovates 2026, Bharat Mandapam, New Delhi (VajraGrid). 1st year, two nationals.",tags:["Oris AI","VajraGrid","TechSynapse","India Innovates"],url:"https://github.com/aerosane",neonColor:"#ffe642",district:"HALL OF FAME",icon:"🏆"}],io={Languages:["C++","Rust","Python","TypeScript","Go","GLSL/HLSL"],Systems:["WebRTC","WebGL/WebGPU","NVENC/NvFBC","Docker","Linux"],"AI/ML":["PyTorch","Gemini API","LangChain","Presidio","HuggingFace"],Web:["React","Next.js","Vite","Node.js","PostgreSQL","Redis"],Tools:["Git","GitHub Actions","Azure","GStreamer","Tokio"]};class so{constructor(){c(this,"group",new xe);c(this,"hoverTargets",[]);c(this,"visible",!1);c(this,"visibleValue",0)}enter(){this.group.visible=!0,this.visible=!0,V.killTweensOf(this),V.to(this,{visibleValue:1,duration:1.4,ease:"power2.out",onUpdate:()=>this.setVisible(this.visibleValue)})}exit(){this.visible=!1,V.killTweensOf(this),V.to(this,{visibleValue:0,duration:.8,ease:"power2.in",onUpdate:()=>this.setVisible(this.visibleValue),onComplete:()=>{this.group.visible=!1}})}setVisible(e){}dispose(){this.group.traverse(e=>{e.geometry&&e.geometry.dispose()})}}let U=null;function ao(){return U||(U=document.createElement("div"),U.id="env-detail-panel",Object.assign(U.style,{position:"fixed",top:"50%",left:"50%",transform:"translate(-50%, -50%) scale(0.92)",background:"rgba(4,6,20,0.92)",border:"1px solid var(--neon, #00f5ff)",boxShadow:"0 0 32px var(--neon, #00f5ff)44",padding:"28px 36px",maxWidth:"480px",width:"90vw",zIndex:"9999",fontFamily:"monospace",color:"#e8f4ff",opacity:"0",pointerEvents:"none",transition:"opacity 0.3s, transform 0.3s",borderRadius:"4px"}),document.body.appendChild(U),U)}function ro(t){var o;const e=ao();e.style.setProperty("--neon",t.neonColor),e.style.borderColor=t.neonColor+"88",e.style.boxShadow=`0 0 40px ${t.neonColor}33`,e.innerHTML=`
  ...
  `,(o=e.querySelector("#env-panel-close"))==null||o.addEventListener("click",i=>{i.stopPropagation(),Ze()}),e.style.pointerEvents="all",e.style.opacity="1",e.style.transform="translate(-50%, -50%) scale(1)"}function Ze(){const t=U;t&&(t.style.opacity="0",t.style.transform="translate(-50%, -50%) scale(0.92)",t.style.pointerEvents="none")}function lo(t){const i=document.createElement("canvas");i.width=900,i.height=440;const n=i.getContext("2d"),s=t.neonColor;n.fillStyle="#03040f",n.fillRect(0,0,900,440);for(let u=0;u<440;u+=4)n.fillStyle="rgba(0,0,0,0.18)",n.fillRect(0,u,900,2);const l=n.createLinearGradient(0,0,14,0);l.addColorStop(0,s),l.addColorStop(1,"transparent"),n.fillStyle=l,n.shadowColor=s,n.shadowBlur=28,n.fillRect(0,0,7,440),n.shadowBlur=0,n.font="bold 11px monospace",n.fillStyle=s+"aa",n.textAlign="left",n.fillText("◈ "+t.district.toUpperCase(),24,28);const a=t.title.length>18?48:t.title.length>13?58:70;n.font=`bold ${a}px monospace`,n.shadowColor=s,n.shadowBlur=50,n.fillStyle="#ffffff",n.fillText(t.title,24,62+(70-a)),n.shadowBlur=26,n.fillStyle=s+"bb",n.fillText(t.title,24,62+(70-a)),n.shadowBlur=0,n.font="18px monospace",n.fillStyle="rgba(255,255,255,0.65)",n.fillText(t.subtitle,24,138),n.font="14px monospace",n.fillStyle="rgba(200,220,255,0.45)";const v=852,w=t.desc.split(" "),h=[];let f="";for(const u of w){const m=f?f+" "+u:u;if(n.measureText(m).width>v){if(h.length===1){h.push(f+"…"),f="";break}h.push(f),f=u}else f=m}f&&h.length<2&&h.push(f),h.forEach((u,m)=>n.fillText(u,24,164+m*20)),n.strokeStyle=s+"30",n.lineWidth=1,n.beginPath(),n.moveTo(24,212),n.lineTo(876,212),n.stroke(),n.font="bold 13px monospace";let d=24;for(const u of t.tags.slice(0,5)){const m=n.measureText(u).width+20;if(d+m>876)break;n.fillStyle=s+"18",n.fillRect(d,224,m,26),n.strokeStyle=s+"66",n.lineWidth=1,n.strokeRect(d,224,m,26),n.fillStyle=s+"ee",n.fillText(u,d+10,241),d+=m+8}return n.font="12px monospace",n.fillStyle="rgba(255,255,255,0.22)",n.fillText(t.url.replace("https://",""),24,278),n.font="bold 13px monospace",n.shadowColor=s,n.shadowBlur=14,n.fillStyle=s+"99",n.fillText("▶  CLICK TO VIEW PROJECT",24,422),n.shadowBlur=0,new qe(i)}function F(t,e,o,i,n){const s=new ee(new we(t,e,o),n);return s.position.copy(i),s.frustumCulled=!1,s}class co extends so{constructor(o,i,n){super();c(this,"projIdx");c(this,"panelPos");c(this,"camPos");c(this,"fadeMats",[]);c(this,"particleMat");this.projIdx=o,this.panelPos=i,this.camPos=n}create(o){o.add(this.group);const i=je[this.projIdx],n=new p(i.neonColor),s=new xe;s.position.copy(this.panelPos);const l=this.camPos.x-this.panelPos.x,a=this.camPos.z-this.panelPos.z;s.rotation.y=Math.atan2(l,a),this.group.add(s);const v=(g,M)=>(g.opacity=0,this.fadeMats.push([g,M]),g),w=v(new _({map:lo(i),transparent:!0,depthWrite:!1,side:ft,alphaTest:.01}),1),h=new ee(new re(40,19.5),w);h.frustumCulled=!1,h.userData.isLabel=!0,h.userData.onClick=()=>ro(i),s.add(h);const f=v(new _({color:n,transparent:!0,blending:Z,depthWrite:!1}),.85);s.add(F(41,.5,.4,new r(0,9.75,.1),f)),s.add(F(41,.5,.4,new r(0,-9.75,.1),f)),s.add(F(.5,20.5,.4,new r(-20.25,0,.1),f)),s.add(F(.5,20.5,.4,new r(20.25,0,.1),f));const d=60,u=v(new _({color:2763326,transparent:!0}),1),m=new r(-13,-9.75-d/2,0),C=new r(13,-9.75-d/2,0);s.add(F(.9,d,.9,m,u)),s.add(F(.9,d,.9,C,u)),s.add(F(27,.7,.9,new r(0,-9.75-d+.4,0),u));const T=v(new _({color:n,transparent:!0,blending:Z,depthWrite:!1}),.5);s.add(F(41,.3,.1,new r(0,9.75,.2),T));const x=60,y=new Float32Array(x*3);for(let g=0;g<x;g++)y[g*3]=this.panelPos.x+(Math.random()-.5)*60,y[g*3+1]=this.panelPos.y+(Math.random()-.5)*35,y[g*3+2]=this.panelPos.z+(Math.random()-.5)*60;const b=new Ye;b.setAttribute("position",new se(y,3)),this.particleMat=new pt({size:.4,color:n,transparent:!0,opacity:0,blending:Z,sizeAttenuation:!0});const S=new Ke(b,this.particleMat);S.frustumCulled=!1,this.group.add(S)}update(o){}setVisible(o){for(const[i,n]of this.fadeMats)i.opacity=o*n;this.particleMat&&(this.particleMat.opacity=o*.45)}onHover(){}}const uo=[[2,0],[3,1],[4,2],[5,3],[6,4],[7,5],[8,6],[9,7],[10,8],[11,9]];class ho{constructor(e,o){c(this,"envs",new Map);c(this,"activeEnv",null);c(this,"activeIdx",-1);for(const[i,n]of uo){const s=k[i],l=new co(n,s.look.clone(),s.pos.clone());l.create(e),l.group.visible=!1,this.envs.set(i,l)}}onSection(e){if(e===this.activeIdx)return;this.activeIdx=e,this.activeEnv&&(this.activeEnv.exit(),this.activeEnv=null);const o=this.envs.get(e);o&&(this.activeEnv=o,o.enter())}update(e){this.activeEnv&&this.activeEnv.update(e)}}const fo=document.getElementById("scene-canvas"),q=new mt({canvas:fo,antialias:!0,alpha:!1,powerPreference:"high-performance"});q.setPixelRatio(Math.min(devicePixelRatio,2));q.setSize(innerWidth,innerHeight);q.toneMapping=gt;q.toneMappingExposure=.95;const A=new vt;A.background=new p(131602);A.fog=new wt(197400,.003);const G=new yt(60,innerWidth/innerHeight,.5,1200),le=new to;le.setup(q,A,G);const Pe=new Kt;Pe.create(A);const D=new qt;D.generate(A);D.addAntennas(A);const po=je.map((t,e)=>{const o=k[e+2];return{text:t.district,pos:new r(o.pos.x+12,80,o.pos.z-18),color:t.neonColor}});D.addNeonSigns(A,po);const Qe=new Zt;Qe.create(A);const Ae=new Xt;Ae.create(A);const et=new Yt;et.create(A);const mo=new bt(128,0,.4);A.add(mo);const Te=new xe;A.add(Te);var _e,Ve;(Ve=(_e=D.cityGroup)==null?void 0:_e.children)==null||Ve.forEach(t=>Te.add(t));const tt=new ho(A,Te),ae=new p(62975);function go(t){const e=Math.min(t,Q.length-1);ae.copy(Q[e]),Ae.setDistrictNeon(ae),Pe.update(0,G.position,ae)}const vo=[["NEON DISTRICT","A cyberpunk portfolio"],["ABOUT","Who is behind this"],["PS3 CELL GPU","PS3 SPU emulator in WebGL"],["CPUonGPU","x86 CPU running on GPU"],["GPU STREAMING","Sub-frame game streaming"],["SELKIES RUST","WebRTC stack rebuilt in Rust"],["ORIS AI","Autonomous SRE agent"],["VAJRAGRID","AI power grid security"],["VIDYAMITRA","Adaptive JEE AI tutor"],["NETFLIP","HLS streaming platform"],["ARENA OJ","Online judge platform"],["HACKATHON","Competition highlights"],["TECH STACK","Tools and languages"],["CONTACT","Get in touch"]],$=document.createElement("div");$.id="section-banner";Object.assign($.style,{position:"fixed",bottom:"24px",left:"50%",transform:"translateX(-50%)",textAlign:"center",pointerEvents:"none",zIndex:"50",opacity:"0",transition:"opacity 0.4s",background:"rgba(0,0,8,0.65)",padding:"10px 28px",borderTop:"1px solid currentColor"});document.body.appendChild($);function wo(t){const[e,o]=vo[t]??["",""],i=Q[t]?"#"+Q[t].getHexString():"#00f5ff";$.style.color=i,$.innerHTML=`
  ...
  `,$.style.opacity="1"}const Ee=new no(G);Ee.onSectionChange=t=>{bo(t),So(t),go(t),le.triggerGlitch(),tt.onSection(t),wo(t)};const yo=document.getElementById("nav-dots");k.forEach((t,e)=>{const o=document.createElement("div");o.className="nav-dot"+(e===0?" active":""),o.title=t.label,o.addEventListener("click",()=>Ee.goTo(e)),yo.appendChild(o)});function bo(t){document.querySelectorAll(".sect").forEach((e,o)=>{e.classList.toggle("active",o===t)}),document.querySelectorAll(".nav-dot").forEach((e,o)=>{e.classList.toggle("active",o===t)})}function So(t){const e=document.getElementById("hud-section");e&&(e.textContent=`DISTRICT_${String(t).padStart(2,"0")} / ${k[t].label}`)}const Oe=document.getElementById("skills-grid");Oe&&Object.entries(io).forEach(([t,e])=>{const o=document.createElement("div");o.className="skill-cat",o.innerHTML=`<div class="skill-cat-name">// ${t}</div>`+e.map(i=>`<div class="skill-item">${i}</div>`).join(""),Oe.appendChild(o)});const N=document.getElementById("contact-input"),ie=document.getElementById("contact-input-display");var $e;($e=document.getElementById("sect-13"))==null||$e.addEventListener("click",()=>N==null?void 0:N.focus());N==null||N.addEventListener("input",()=>{ie&&(ie.textContent=(N.value||"")+"_"),N.value.trim().toLowerCase()==="sudo"&&(Co(),N.value="",ie&&(ie.textContent="_"))});function Co(){const t=document.querySelector("#sect-13 .terminal-body");if(!t)return;const e=document.createElement("p");e.className="output neon-green",e.textContent="> Permission granted. Downloading your future...",t.appendChild(e),setTimeout(()=>{const o=document.createElement("p");o.className="output",o.innerHTML='<span style="color:#ffe642">root@neon-district:~# ██████████ 100%  COMPLETE</span>',t.appendChild(o)},1500)}const ze=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight","b","a"];let X=0;window.addEventListener("keydown",t=>{t.key===ze[X]?X++:X=0,X===ze.length&&(X=0,xo())});let pe=!1;function xo(){pe=!pe,[D.meshA,D.meshB,D.meshC].forEach(t=>{const e=t.material;e.wireframe=pe})}const me=document.getElementById("boot-log"),Be=document.getElementById("boot-bar"),Y=document.getElementById("loading-screen"),ge=["Initializing WebGPU context","Generating city geometry","Compiling 47 shader programs","Spawning rain particles","Calibrating post-processing chain","System ready"];async function Po(){for(let t=0;t<ge.length;t++){await new Promise(o=>setTimeout(o,260+Math.random()*200));const e=document.createElement("p");e.innerHTML=`<span style="color:rgba(0,245,255,.5)">[BOOT]</span> ${ge[t]}... <span class="ok">[OK]</span>`,me==null||me.appendChild(e),Be&&(Be.style.width=(t+1)/ge.length*100+"%")}await new Promise(t=>setTimeout(t,600)),Y==null||Y.classList.add("fade-out"),setTimeout(()=>{Y&&(Y.style.display="none")},850)}Po();const He=new St,ve=new J;window.addEventListener("click",t=>{if(t.target.closest("#env-detail-panel"))return;ve.x=t.clientX/innerWidth*2-1,ve.y=-(t.clientY/innerHeight)*2+1,He.setFromCamera(ve,G);const e=He.intersectObjects(A.children,!0);for(const o of e){const i=o.object;if(i.userData.isLabel&&i.userData.onClick){t.stopPropagation(),i.userData.onClick();return}}Ze()});window.addEventListener("resize",()=>{G.aspect=innerWidth/innerHeight,G.updateProjectionMatrix(),q.setSize(innerWidth,innerHeight),le.resize(innerWidth,innerHeight)});const We=new Ct;function ot(){requestAnimationFrame(ot);const t=We.getElapsedTime(),e=We.getDelta();D.update(t),Ae.update(t),et.update(t,G.position),Qe.update(t),Pe.update(t,G.position,ae),Ee.update(e),tt.update(t),le.render()}ot();
