var ft=Object.defineProperty;var ut=(i,t,n)=>t in i?ft(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n;var h=(i,t,n)=>ut(i,typeof t!="symbol"?t+"":t,n);import{i as M,d as pe,I as oe,q as X,u as Y,s as ne,a2 as d,Q as se,x as ge,m as Ae,j as Ce,a as ae,C as Oe,t as we,X as Se,f as nt,e as Me,y as st,Y as ht,B as pt,E as mt,a1 as me,_ as gt,g as qe,G as ze,p as vt,z as wt,a5 as St,A as yt,W as bt,o as Ct,P as Tt,H as Pt,S as At,h as Mt}from"./three-uBnUpQ-C.js";import{b as Et,R as kt,a as Rt,B as Re,C as It,V as Lt,N as xt,S as Nt,G as Dt,c as Ie,E as Ut}from"./postprocessing-DQ1XEIde.js";import{g as ie}from"./gsap-SFc2wnMY.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();function Xe(i){return i*i*i*(i*(i*6-15)+10)}function Le(i,t,n){return i+n*(t-i)}function Te(i,t,n){const s=i&3,o=s<2?t:n,a=s<2?n:t;return(i&1?-o:o)+(i&2?-a:a)}const j=Array.from({length:512},(i,t)=>t).sort(()=>Math.random()-.5);for(let i=0;i<256;i++)j[i+256]=j[i];function Gt(i,t){const n=Math.floor(i)&255,s=Math.floor(t)&255,o=i-Math.floor(i),a=t-Math.floor(t),c=Xe(o),l=Xe(a),v=j[j[n]+s],C=j[j[n]+s+1],m=j[j[n+1]+s],w=j[j[n+1]+s+1];return Le(Le(Te(v,o,a),Te(m,o-1,a),c),Le(Te(C,o,a-1),Te(w,o-1,a-1),c),l)}function fe(i,t,n=4,s=2,o=.5){let a=0,c=.5,l=1;for(let v=0;v<n;v++)a+=Gt(i*l,t*l)*c,l*=s,c*=o;return a}function S(i,t){return i+Math.random()*(t-i)}function te(i,t){return Math.floor(S(i,t+1))}const Ot=`
...
`,A=32,O=16,jt=6,B=O+jt,q=A/2*B,xe={color:new M(197400),near:100,far:500},ve=[new M(62975),new M(62975),new M(16711850),new M(16711850),new M(16739098),new M(8073215),new M(8073215),new M(65416),new M(65416),new M(16770626)];function Yt(){return new Se({vertexShader:Ot,fragmentShader:Ft,uniforms:{uTime:{value:0},uFogColor:{value:xe.color},uFogNear:{value:xe.near},uFogFar:{value:xe.far}}})}function $t(i,t){const n=i/A,s=t/A;return n<.35&&s<.35?0:n<.65&&s<.35?1:n>=.65&&s<.35?2:n<.35&&s<.65?3:n>=.65&&s<.65?4:n<.35&&s>=.65?5:n<.65&&s>=.65?6:n>=.65&&s>=.65?7:s>.45&&s<.55?8:9}class Kt{constructor(){h(this,"sectionLow");h(this,"sectionMid");h(this,"sectionTop");h(this,"meshD");h(this,"meshLedge");h(this,"mats",[])}generate(t){const n=A*A,s=Yt();this.mats.push(s);const o=()=>{const e=new pe(1,1,1),r=new Float32Array(n),p=new Float32Array(n*3);e.setAttribute("aHeight",new oe(r,1)),e.setAttribute("aNeonColor",new oe(p,3));const I=new X(e,s.clone(),n);return I.frustumCulled=!1,{geo:e,heights:r,colors:p,mesh:I}},a=o(),c=o(),l=o();this.sectionLow=a.mesh,this.sectionMid=c.mesh,this.sectionTop=l.mesh;for(const e of[a.mesh,c.mesh,l.mesh])this.mats.push(e.material);const v=new pe(1,1,1),C=new Float32Array(n),m=new Float32Array(n*3);v.setAttribute("aHeight",new oe(C,1)),v.setAttribute("aNeonColor",new oe(m,3)),this.meshD=new X(v,s.clone(),n),this.meshD.frustumCulled=!1,this.mats.push(this.meshD.material);const w=new pe(1,1,1),g=new Y({color:789524});this.meshLedge=new X(w,g,A*A*6),this.meshLedge.frustumCulled=!1,this.meshLedge.count=0;const f=new ne,u=new d,y=new d,b=new se;let T=0,E=0,k=0,L=0,P=0;for(let e=0;e<A;e++)for(let r=0;r<A;r++){const p=e*B-q,I=r*B-q;if(e%5===0||r%5===0||e%2===0&&r%2===0&&Math.random()<.25)continue;const W=e/A*4-2,G=r/A*4-2,$=fe(W,G,5),K=Math.sqrt(W*W+G*G)/3,J=Math.max(.18,1-K*.6),R=Math.max(8,(22+$*170)*J)+S(4,28),N=S(O*.42,O*.9),z=S(O*.42,O*.9),ye=$t(e,r),U=ve[ye],ce=R*.62;if(a.heights[T]=R,a.colors[T*3]=U.r,a.colors[T*3+1]=U.g,a.colors[T*3+2]=U.b,u.set(p,ce/2,I),y.set(N,ce,z),f.compose(u,b,y),this.sectionLow.setMatrixAt(T,f),T++,R>40){const D=R*.23,H=N*.68,_=z*.68;c.heights[E]=R,c.colors[E*3]=U.r,c.colors[E*3+1]=U.g,c.colors[E*3+2]=U.b,u.set(p,R*.62+D/2,I),y.set(H,D,_),f.compose(u,b,y),this.sectionMid.setMatrixAt(E,f),E++}if(R>100){const D=R*.15,H=N*.38,_=z*.38;l.heights[k]=R,l.colors[k*3]=U.r,l.colors[k*3+1]=U.g,l.colors[k*3+2]=U.b,u.set(p,R*.85+D/2,I),y.set(H,D,_),f.compose(u,b,y),this.sectionTop.setMatrixAt(k,f),k++}if(Math.random()>=.95){const D=S(1.5,4),H=S(1.5,4),_=R*1.8;C[L]=_,m[L*3]=U.r,m[L*3+1]=U.g,m[L*3+2]=U.b,u.set(p+S(-2,2),_/2,I+S(-2,2)),y.set(D,_,H),f.compose(u,b,y),this.meshD.setMatrixAt(L,f),L++}const be=Math.floor(S(2,4));for(let D=1;D<=be;D++){const H=D/(be+1)*ce;u.set(p,H,I),y.set(N+1.2,.7,z+1.2),f.compose(u,b,y),this.meshLedge.setMatrixAt(P,f),P++}R>40&&(u.set(p,R*.62,I),y.set(N*.72,.7,z*.72),f.compose(u,b,y),this.meshLedge.setMatrixAt(P,f),P++),R>100&&(u.set(p,R*.85,I),y.set(N*.42,.7,z*.42),f.compose(u,b,y),this.meshLedge.setMatrixAt(P,f),P++)}this.sectionLow.count=T,this.sectionMid.count=E,this.sectionTop.count=k,this.meshD.count=L;for(const e of[this.sectionLow,this.sectionMid,this.sectionTop,this.meshD]){e.instanceMatrix.needsUpdate=!0;const r=e.geometry;r.getAttribute("aHeight").needsUpdate=!0,r.getAttribute("aNeonColor").needsUpdate=!0,t.add(e)}this.meshLedge.count=P,this.meshLedge.instanceMatrix.needsUpdate=!0,t.add(this.meshLedge)}addBillboardScreens(t){const s=e=>{const r=document.createElement("canvas");r.width=512,r.height=256;const p=r.getContext("2d");return e(p),new Oe(r)},o=s(e=>{e.fillStyle="#000",e.fillRect(0,0,512,256),e.strokeStyle="#00f5ff",e.lineWidth=2;for(let r=0;r<6;r++)e.beginPath(),e.moveTo(20,30+r*36),e.lineTo(492,30+r*36),e.stroke();e.fillStyle="#00f5ff";for(let r=0;r<8;r++)for(let p=0;p<5;p++)e.beginPath(),e.arc(40+r*60,30+p*36,5,0,Math.PI*2),e.fill();e.font="bold 32px monospace",e.fillStyle="#00f5ff88",e.textAlign="center",e.fillText("SYSTEM ONLINE",256,230)}),a=s(e=>{e.fillStyle="#000",e.fillRect(0,0,512,256),e.fillStyle="#ff00aa18";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo(r*30,0),e.lineTo(r*30+30,0),e.lineTo(r*30+30+256,256),e.lineTo(r*30+256,256),e.closePath(),e.fill();e.strokeStyle="#ff00aa",e.lineWidth=3,e.strokeRect(6,6,500,244),e.fillStyle="#ff00aa",e.font="bold 56px monospace",e.textAlign="center",e.fillText("DANGER",256,110),e.font="bold 42px serif",e.fillText("危険区域",256,180),e.font="18px monospace",e.fillStyle="#ff00aa88",e.fillText("AUTHORIZED PERSONNEL ONLY",256,230)}),c=s(e=>{e.fillStyle="#0a0500",e.fillRect(0,0,512,256),e.fillStyle="#ff8800",e.font="bold 28px monospace",e.textAlign="left",["GPU-X  ▲ 4821.3","NET-7  ▼ 219.08","SYS-4  ▲ 1104.7","AI-12  ▲ 8820.0","HRD-3  ▼  553.2"].forEach((p,I)=>e.fillText(p,20,48+I*44)),e.strokeStyle="#ff8800",e.lineWidth=2,e.strokeRect(6,6,500,244),e.fillStyle="#ff880044",e.fillRect(6,6,500,30),e.fillStyle="#ff8800",e.font="bold 22px monospace",e.textAlign="center",e.fillText("◈ NEON DISTRICT EXCHANGE ◈",256,26)}),l=s(e=>{e.fillStyle="#000510",e.fillRect(0,0,512,256),e.strokeStyle="#4488ff",e.lineWidth=2;for(let r=20;r<110;r+=22){e.beginPath();for(let p=0;p<6;p++){const I=p*Math.PI/3-Math.PI/6,W=256+Math.cos(I)*r,G=128+Math.sin(I)*r;p===0?e.moveTo(W,G):e.lineTo(W,G)}e.closePath(),e.stroke()}e.fillStyle="#4488ff",e.font="bold 22px monospace",e.textAlign="center",e.fillText("NEXUS CORP",256,220),e.font="14px monospace",e.fillStyle="#4488ff88",e.fillText("EST. 2047  |  SECTOR 7",256,248)}),v=s(e=>{e.fillStyle="#000a00",e.fillRect(0,0,512,256),e.fillStyle="#00ff44",e.font="12px monospace";for(let r=0;r<32;r++)for(let p=0;p<16;p++)Math.random()>.45&&e.fillText(Math.random()>.5?"1":"0",8+r*16,14+p*15);e.fillStyle="#00ff4422",e.fillRect(0,0,512,256),e.strokeStyle="#00ff44",e.lineWidth=2,e.strokeRect(4,4,504,248),e.fillStyle="#00ff44",e.font="bold 34px monospace",e.textAlign="center",e.shadowBlur=16,e.shadowColor="#00ff44",e.fillText("MATRIX CORE",256,148),e.shadowBlur=0}),C=s(e=>{e.fillStyle="#05000a",e.fillRect(0,0,512,256),e.strokeStyle="#aa00ff",e.lineWidth=3,e.strokeRect(6,6,500,244),e.strokeStyle="#aa00ff66",e.lineWidth=1,e.strokeRect(16,16,480,224),e.fillStyle="#aa00ff",e.font="bold 40px monospace",e.textAlign="center",e.shadowBlur=20,e.shadowColor="#aa00ff",e.fillText("RESTRICTED",256,100),e.fillText("ACCESS",256,155),e.shadowBlur=0,e.font="16px monospace",e.fillStyle="#aa00ff88",e.fillText("CLEARANCE LEVEL Ω REQUIRED",256,220)}),m=s(e=>{e.fillStyle="#0a0000",e.fillRect(0,0,512,256),e.fillStyle="#ff112244",e.fillRect(0,0,512,256),e.strokeStyle="#ff1122",e.lineWidth=4,e.strokeRect(6,6,500,244),e.fillStyle="#ff1122",e.font="bold 80px monospace",e.textAlign="center",e.fillText("⚠",256,140),e.font="bold 28px monospace",e.fillText("ALERT",256,200),e.font="14px monospace",e.fillStyle="#ff112288",e.fillText("EMERGENCY BROADCAST ACTIVE",256,240)}),w=s(e=>{e.fillStyle="#080400",e.fillRect(0,0,512,256),e.fillStyle="#ff8800";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo(r*28,0),e.lineTo(r*28+28,0),e.lineTo(r*28+28+256,256),e.lineTo(r*28+256,256),e.closePath(),e.fill();e.fillStyle="#080400";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo((r+1)*28,0),e.lineTo((r+1)*28+28,0),e.lineTo((r+1)*28+28+256,256),e.lineTo((r+1)*28+256,256),e.closePath(),e.fill();e.fillStyle="#ff8800",e.font="bold 52px monospace",e.textAlign="center",e.fillText("UNDER",256,110),e.fillText("CONSTRUCTION",256,175),e.font="16px monospace",e.fillText("SECTOR 4 - ZONE B",256,230)}),g=[o,a,c,l,v,C,m,w],f=new ge(1,1),u=g.map(e=>{const r=new Y({map:e,transparent:!1,side:Ae}),p=new X(f,r,20);return p.frustumCulled=!1,p.count=0,p}),y=new Array(8).fill(0),b=new ne,T=new d,E=new se,k=new d,L=new d(0,1,0),P=8*20;for(let e=0;e<P;e++){const r=e%8,p=y[r];if(p>=20)continue;const I=te(1,A-2),W=te(1,A-2),G=I*B-q,$=W*B-q,K=I/A*4-2,J=W/A*4-2,R=Math.max(.18,1-Math.sqrt(K*K+J*J)/3*.6),N=Math.max(8,(22+fe(K,J,5)*170)*R)+S(4,28),z=S(O*.55,O*.85),ye=S(O*.55,O*.85),U=S(18,50),ce=S(10,28),be=S(N*.25,N*.55),D=Math.floor(Math.random()*4);let H=G,_=$,de=0;D===0?(_=$+ye/2+.3,de=0):D===1?(_=$-ye/2-.3,de=Math.PI):D===2?(H=G+z/2+.3,de=Math.PI/2):(H=G-z/2-.3,de=-Math.PI/2),T.set(H,be,_),E.setFromAxisAngle(L,de),k.set(U,ce,1),b.compose(T,E,k),u[r].setMatrixAt(p,b),y[r]++}for(let e=0;e<8;e++)u[e].count=y[e],u[e].instanceMatrix.needsUpdate=!0,t.add(u[e])}addRooftopEquipment(t){const n=new Y({color:526352}),s=new pe(1,1,1),o=new Ce(.5,.5,1,8),a=new Ce(.05,1,.6,12),c=new X(s,n.clone(),200),l=new X(o,n.clone(),200),v=new X(a,n.clone(),200);c.frustumCulled=l.frustumCulled=v.frustumCulled=!1;let C=0,m=0,w=0;const g=new ne,f=new d,u=new d,y=new se;for(let b=0;b<A;b++)for(let T=0;T<A;T++){if(b%5===0||T%5===0)continue;const E=b*B-q,k=T*B-q,L=b/A*4-2,P=T/A*4-2,e=Math.max(.18,1-Math.sqrt(L*L+P*P)/3*.6),r=Math.max(8,(22+fe(L,P,5)*170)*e)+S(4,28),p=S(O*.55,O*.85),I=S(O*.55,O*.85);if(r<60||Math.random()>.2)continue;const W=te(1,3);for(let G=0;G<W;G++){const $=E+S(-p*.3,p*.3),K=k+S(-I*.3,I*.3),J=Math.random();if(J<.5&&C<200){const R=S(2,6),N=S(3,8),z=S(2,6);f.set($,r+N/2,K),u.set(R,N,z),g.compose(f,y,u),c.setMatrixAt(C++,g)}else if(J<.8&&m<200){const R=S(1,3),N=S(4,10);f.set($,r+N/2,K),u.set(R*2,N,R*2),g.compose(f,y,u),l.setMatrixAt(m++,g)}else if(w<200){const R=S(2,5);f.set($,r+.3,K),u.set(R*2,1,R*2),g.compose(f,y,u),v.setMatrixAt(w++,g)}}}c.count=C,c.instanceMatrix.needsUpdate=!0,t.add(c),l.count=m,l.instanceMatrix.needsUpdate=!0,t.add(l),v.count=w,v.instanceMatrix.needsUpdate=!0,t.add(v)}addSearchlights(t){const n=new Ce(.3,2.5,1,6,1,!0),s=[{color:16777215,opacity:.08,count:34},{color:4521983,opacity:.07,count:26},{color:16729258,opacity:.07,count:20}],o=new ne,a=new d,c=new d,l=new se;for(const v of s){const C=new Y({color:v.color,transparent:!0,opacity:v.opacity,side:Ae,blending:ae,depthWrite:!1}),m=new X(n,C,v.count);m.frustumCulled=!1;for(let w=0;w<v.count;w++){const g=te(0,A-1),f=te(0,A-1),u=g*B-q,y=f*B-q,b=g/A*4-2,T=f/A*4-2,E=Math.max(.18,1-Math.sqrt(b*b+T*T)/3*.6),k=Math.max(8,(22+fe(b,T,5)*170)*E)+S(4,28);a.set(u+S(-2,2),k+150,y+S(-2,2)),c.set(1,300,1),o.compose(a,l,c),m.setMatrixAt(w,o)}m.instanceMatrix.needsUpdate=!0,t.add(m)}}addAntennas(t){const n=new Ce(.1,.1,1,4),s=new Y({color:16716083}),o=new X(n,s,400);o.frustumCulled=!1;const a=new ne,c=new d,l=new d,v=new se;let C=0;for(let m=0;m<400;m++){const w=te(0,A-1),g=te(0,A-1),f=w*B-q,u=g*B-q,y=w/A*4-2,b=g/A*4-2,T=Math.max(.18,1-Math.sqrt(y*y+b*b)/3*.6),E=Math.max(8,(22+fe(y,b,5)*170)*T)+20,k=S(8,30);c.set(f+S(-3,3),E+k/2,u+S(-3,3)),l.set(1,k,1),a.compose(c,v,l),o.setMatrixAt(C++,a)}o.count=C,o.instanceMatrix.needsUpdate=!0,t.add(o)}addNeonSigns(t,n){n.forEach(({text:s,pos:o,color:a})=>{const c=document.createElement("canvas");c.width=256,c.height=64;const l=c.getContext("2d");l.clearRect(0,0,256,64),l.fillStyle=a+"22",l.fillRect(0,0,256,64),l.strokeStyle=a,l.lineWidth=2,l.strokeRect(2,2,252,60),l.fillStyle=a,l.font="bold 22px monospace",l.textAlign="center",l.fillText(s,128,40);const v=new Oe(c),C=new ge(18,4.5),m=new Y({map:v,transparent:!0,side:Ae,depthWrite:!1}),w=new we(C,m);w.position.copy(o),t.add(w)})}update(t){for(const n of this.mats)n.uniforms.uTime.value=t}}class Zt{constructor(){h(this,"mesh");h(this,"mat")}create(t){const n=new ge(1200,1200,1,1);return this.mat=new Se({vertexShader:Wt,fragmentShader:zt,uniforms:{uTime:{value:0},uDistrictNeon:{value:new M(62975)},uRainIntensity:{value:1}}}),this.mesh=new we(n,this.mat),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=0,t.add(this.mesh),this.mesh}update(t){this.mat.uniforms.uTime.value=t}setDistrictNeon(t){this.mat.uniforms.uDistrictNeon.value.copy(t)}setRainIntensity(t){this.mat.uniforms.uRainIntensity.value=t}}class Jt{constructor(){h(this,"points");h(this,"count",8e3)}create(t){const n=new Float32Array(this.count*3),s=new Float32Array(this.count),o=new Float32Array(this.count);for(let l=0;l<this.count;l++)n[l*3]=S(-300,300),n[l*3+1]=S(-60,60),n[l*3+2]=S(-300,300),s[l]=S(.3,1),o[l]=Math.random();const a=new nt;a.setAttribute("position",new Me(n,3)),a.setAttribute("aSpeed",new Me(s,1)),a.setAttribute("aOffset",new Me(o,1));const c=new Se({vertexShader:Ht,fragmentShader:_t,uniforms:{uTime:{value:0}},transparent:!0,blending:ae,depthWrite:!1});this.points=new st(a,c),t.add(this.points)}update(t,n){const s=this.points.material;s.uniforms.uTime.value=t,n&&(this.points.position.x=n.x,this.points.position.z=n.z)}}class Qt{constructor(){h(this,"mesh");h(this,"mat")}create(t){const n=new ht(2e3,32,16);this.mat=new Se({vertexShader:Bt,fragmentShader:Vt,uniforms:{uTime:{value:0},uZenithColor:{value:new M(132104)},uHorizonColor:{value:new M(1706e3)},uDistrictNeon:{value:new M(62975)}},side:pt,depthWrite:!1}),this.mesh=new we(n,this.mat),this.mesh.renderOrder=-1,t.add(this.mesh)}update(t,n,s){this.mesh.position.copy(n),this.mat.uniforms.uTime.value=t,s&&this.mat.uniforms.uDistrictNeon.value.copy(s)}setDistrictColors(t,n){this.mat.uniforms.uHorizonColor.value.copy(t),this.mat.uniforms.uDistrictNeon.value.copy(n)}}function eo(i){let t=i;return()=>{t|=0,t=t+1831565813|0;let n=Math.imul(t^t>>>15,1|t);return n=n+Math.imul(n^n>>>7,61|n)^n,((n^n>>>14)>>>0)/4294967296}}const je=[new M(16720384),new M(61183),new M(22015),new M(16711884),new M(65382),new M(16737792),new M(11141375),new M(16770626)],Fe=32,it=16,to=6,We=it+to,Ye=Fe/2*We;class oo{constructor(){h(this,"mesh");h(this,"mat")}create(t){const s=new ge(5,1.4),o=new Float32Array(150*3),a=new Float32Array(150),c=new Float32Array(150);s.setAttribute("aColor",new oe(o,3)),s.setAttribute("aFlickerSeed",new oe(a,1)),s.setAttribute("aPulseMode",new oe(c,1)),this.mat=new Se({vertexShader:qt,fragmentShader:Xt,uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,side:Ae,blending:ae}),this.mesh=new X(s,this.mat,150),this.mesh.frustumCulled=!1;const l=eo(42),v=new ne,C=new d,m=new se,w=new d(1,1,1);let g=0;for(let f=0;f<Fe&&g<150;f++)for(let u=0;u<Fe&&g<150;u++){if(f%5===0||u%5===0||l()>.1)continue;const y=f*We-Ye,b=u*We-Ye,T=6+l()*12,E=Math.floor(l()*4),k=it*.5+.3;let L=y,P=b,e=0;E===0?(P=b+k,e=0):E===1?(P=b-k,e=Math.PI):E===2?(L=y+k,e=Math.PI*.5):(L=y-k,e=-Math.PI*.5),C.set(L,T,P),m.setFromEuler(new mt(0,e,0)),v.compose(C,m,w),this.mesh.setMatrixAt(g,v);const r=je[Math.floor(l()*je.length)];o[g*3]=r.r,o[g*3+1]=r.g,o[g*3+2]=r.b,a[g]=l();const p=l();c[g]=p<.6?0:p<.85?1:p<.95?2:3,g++}this.mesh.count=g,this.mesh.instanceMatrix.needsUpdate=!0,s.getAttribute("aColor").needsUpdate=!0,s.getAttribute("aFlickerSeed").needsUpdate=!0,s.getAttribute("aPulseMode").needsUpdate=!0,t.add(this.mesh)}update(t){this.mat.uniforms.uTime.value=t}}const no=`
