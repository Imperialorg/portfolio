var ct=Object.defineProperty;var dt=(i,t,n)=>t in i?ct(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n;var m=(i,t,n)=>dt(i,typeof t!="symbol"?t+"":t,n);import{i as A,d as de,I as J,q as V,u as X,s as te,a2 as d,Q as oe,x as he,m as be,j as we,a as se,C as Ue,t as pe,X as ge,f as tt,e as Ce,y as ot,Y as ft,B as ut,E as ht,a1 as fe,_ as mt,g as _e,G as Fe,p as pt,z as gt,a5 as vt,A as wt,W as yt,o as St,P as bt,H as Ct,S as Tt,h as Pt}from"./three-uBnUpQ-C.js";import{b as At,R as Et,a as Mt,B as Ee,C as kt,V as Rt,N as It,S as Lt,G as Nt,c as Me,E as xt}from"./postprocessing-DQ1XEIde.js";import{g as ne}from"./gsap-SFc2wnMY.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();function Ve(i){return i*i*i*(i*(i*6-15)+10)}function ke(i,t,n){return i+n*(t-i)}function ye(i,t,n){const s=i&3,o=s<2?t:n,a=s<2?n:t;return(i&1?-o:o)+(i&2?-a:a)}const q=Array.from({length:512},(i,t)=>t).sort(()=>Math.random()-.5);for(let i=0;i<256;i++)q[i+256]=q[i];function Dt(i,t){const n=Math.floor(i)&255,s=Math.floor(t)&255,o=i-Math.floor(i),a=t-Math.floor(t),c=Ve(o),l=Ve(a),v=q[q[n]+s],C=q[q[n]+s+1],p=q[q[n+1]+s],w=q[q[n+1]+s+1];return ke(ke(ye(v,o,a),ye(p,o-1,a),c),ke(ye(C,o,a-1),ye(w,o-1,a-1),c),l)}function Re(i,t,n=4,s=2,o=.5){let a=0,c=.5,l=1;for(let v=0;v<n;v++)a+=Dt(i*l,t*l)*c,l*=s,c*=o;return a}function S(i,t){return i+Math.random()*(t-i)}function re(i,t){return Math.floor(S(i,t+1))}const Ut=`
...
`,I=32,ue=16,qt=6,Z=ue+qt,ee=I/2*Z,Ie={color:new A(197400),near:100,far:500},me=[new A(62975),new A(62975),new A(16711850),new A(16711850),new A(16739098),new A(8073215),new A(8073215),new A(65416),new A(65416),new A(16770626)];function Xt(){return new ge({vertexShader:Ut,fragmentShader:Gt,uniforms:{uTime:{value:0},uFogColor:{value:Ie.color},uFogNear:{value:Ie.near},uFogFar:{value:Ie.far}}})}function jt(i,t){const n=i/I,s=t/I;return n<.35&&s<.35?0:n<.65&&s<.35?1:n>=.65&&s<.35?2:n<.35&&s<.65?3:n>=.65&&s<.65?4:n<.35&&s>=.65?5:n<.65&&s>=.65?6:n>=.65&&s>=.65?7:s>.45&&s<.55?8:9}class Yt{constructor(){m(this,"sectionLow");m(this,"sectionMid");m(this,"sectionTop");m(this,"meshD");m(this,"meshLedge");m(this,"mats",[]);m(this,"buildings",[])}generate(t){const n=I*I,s=Xt();this.mats.push(s);const o=()=>{const e=new de(1,1,1),r=new Float32Array(n),h=new Float32Array(n*3);e.setAttribute("aHeight",new J(r,1)),e.setAttribute("aNeonColor",new J(h,3));const k=new V(e,s.clone(),n);return k.frustumCulled=!1,{geo:e,heights:r,colors:h,mesh:k}},a=o(),c=o(),l=o();this.sectionLow=a.mesh,this.sectionMid=c.mesh,this.sectionTop=l.mesh;for(const e of[a.mesh,c.mesh,l.mesh])this.mats.push(e.material);const v=new de(1,1,1),C=new Float32Array(n),p=new Float32Array(n*3);v.setAttribute("aHeight",new J(C,1)),v.setAttribute("aNeonColor",new J(p,3)),this.meshD=new V(v,s.clone(),n),this.meshD.frustumCulled=!1,this.mats.push(this.meshD.material);const w=new de(1,1,1),g=new X({color:789524});this.meshLedge=new V(w,g,I*I*6),this.meshLedge.frustumCulled=!1,this.meshLedge.count=0;const f=new te,u=new d,y=new d,T=new oe;let M=0,E=0,P=0,R=0,b=0;for(let e=0;e<I;e++)for(let r=0;r<I;r++){const h=e*Z-ee,k=r*Z-ee;if(e%5===0||r%5===0||e%2===0&&r%2===0&&Math.random()<.25)continue;const O=e/I*4-2,L=r/I*4-2,z=Re(O,L,5),Q=Math.sqrt(O*O+L*L)/3,Ae=Math.max(.18,1-Q*.6),N=Math.max(8,(22+z*170)*Ae)+S(4,28),B=S(ue*.42,ue*.9),_=S(ue*.42,ue*.9),ve=jt(e,r),U=me[ve],K=N*.62;if(a.heights[M]=N,a.colors[M*3]=U.r,a.colors[M*3+1]=U.g,a.colors[M*3+2]=U.b,u.set(h,K/2,k),y.set(B,K,_),f.compose(u,T,y),this.sectionLow.setMatrixAt(M,f),M++,this.buildings.push({wx:h,wz:k,fw:B,fd:_,h:N}),N>40){const G=N*.23,F=B*.68,D=_*.68;c.heights[E]=N,c.colors[E*3]=U.r,c.colors[E*3+1]=U.g,c.colors[E*3+2]=U.b,u.set(h,N*.62+G/2,k),y.set(F,G,D),f.compose(u,T,y),this.sectionMid.setMatrixAt(E,f),E++}if(N>100){const G=N*.15,F=B*.38,D=_*.38;l.heights[P]=N,l.colors[P*3]=U.r,l.colors[P*3+1]=U.g,l.colors[P*3+2]=U.b,u.set(h,N*.85+G/2,k),y.set(F,G,D),f.compose(u,T,y),this.sectionTop.setMatrixAt(P,f),P++}if(Math.random()>=.95){const G=S(1.5,4),F=S(1.5,4),D=N*1.8;C[R]=D,p[R*3]=U.r,p[R*3+1]=U.g,p[R*3+2]=U.b,u.set(h+S(-2,2),D/2,k+S(-2,2)),y.set(G,D,F),f.compose(u,T,y),this.meshD.setMatrixAt(R,f),R++}if(Math.random()<.5){const G=Math.floor(S(2,4));for(let F=1;F<=G;F++){const D=F/(G+1)*K;u.set(h,D,k),y.set(B+1.2,.7,_+1.2),f.compose(u,T,y),this.meshLedge.setMatrixAt(b,f),b++}N>40&&(u.set(h,N*.62,k),y.set(B*.72,.7,_*.72),f.compose(u,T,y),this.meshLedge.setMatrixAt(b,f),b++),N>100&&(u.set(h,N*.85,k),y.set(B*.42,.7,_*.42),f.compose(u,T,y),this.meshLedge.setMatrixAt(b,f),b++)}}this.sectionLow.count=M,this.sectionMid.count=E,this.sectionTop.count=P,this.meshD.count=R;for(const e of[this.sectionLow,this.sectionMid,this.sectionTop,this.meshD]){e.instanceMatrix.needsUpdate=!0;const r=e.geometry;r.getAttribute("aHeight").needsUpdate=!0,r.getAttribute("aNeonColor").needsUpdate=!0,t.add(e)}this.meshLedge.count=b,this.meshLedge.instanceMatrix.needsUpdate=!0,t.add(this.meshLedge)}addBillboardScreens(t){const s=e=>{const r=document.createElement("canvas");r.width=512,r.height=256;const h=r.getContext("2d");return e(h),new Ue(r)},o=s(e=>{e.fillStyle="#000",e.fillRect(0,0,512,256),e.strokeStyle="#00f5ff",e.lineWidth=2;for(let r=0;r<6;r++)e.beginPath(),e.moveTo(20,30+r*36),e.lineTo(492,30+r*36),e.stroke();e.fillStyle="#00f5ff";for(let r=0;r<8;r++)for(let h=0;h<5;h++)e.beginPath(),e.arc(40+r*60,30+h*36,5,0,Math.PI*2),e.fill();e.font="bold 32px monospace",e.fillStyle="#00f5ff88",e.textAlign="center",e.fillText("SYSTEM ONLINE",256,230)}),a=s(e=>{e.fillStyle="#000",e.fillRect(0,0,512,256),e.fillStyle="#ff00aa18";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo(r*30,0),e.lineTo(r*30+30,0),e.lineTo(r*30+30+256,256),e.lineTo(r*30+256,256),e.closePath(),e.fill();e.strokeStyle="#ff00aa",e.lineWidth=3,e.strokeRect(6,6,500,244),e.fillStyle="#ff00aa",e.font="bold 56px monospace",e.textAlign="center",e.fillText("DANGER",256,110),e.font="bold 42px serif",e.fillText("危険区域",256,180),e.font="18px monospace",e.fillStyle="#ff00aa88",e.fillText("AUTHORIZED PERSONNEL ONLY",256,230)}),c=s(e=>{e.fillStyle="#0a0500",e.fillRect(0,0,512,256),e.fillStyle="#ff8800",e.font="bold 28px monospace",e.textAlign="left",["GPU-X  ▲ 4821.3","NET-7  ▼ 219.08","SYS-4  ▲ 1104.7","AI-12  ▲ 8820.0","HRD-3  ▼  553.2"].forEach((h,k)=>e.fillText(h,20,48+k*44)),e.strokeStyle="#ff8800",e.lineWidth=2,e.strokeRect(6,6,500,244),e.fillStyle="#ff880044",e.fillRect(6,6,500,30),e.fillStyle="#ff8800",e.font="bold 22px monospace",e.textAlign="center",e.fillText("◈ NEON DISTRICT EXCHANGE ◈",256,26)}),l=s(e=>{e.fillStyle="#000510",e.fillRect(0,0,512,256),e.strokeStyle="#4488ff",e.lineWidth=2;for(let r=20;r<110;r+=22){e.beginPath();for(let h=0;h<6;h++){const k=h*Math.PI/3-Math.PI/6,O=256+Math.cos(k)*r,L=128+Math.sin(k)*r;h===0?e.moveTo(O,L):e.lineTo(O,L)}e.closePath(),e.stroke()}e.fillStyle="#4488ff",e.font="bold 22px monospace",e.textAlign="center",e.fillText("NEXUS CORP",256,220),e.font="14px monospace",e.fillStyle="#4488ff88",e.fillText("EST. 2047  |  SECTOR 7",256,248)}),v=s(e=>{e.fillStyle="#000a00",e.fillRect(0,0,512,256),e.fillStyle="#00ff44",e.font="12px monospace";for(let r=0;r<32;r++)for(let h=0;h<16;h++)Math.random()>.45&&e.fillText(Math.random()>.5?"1":"0",8+r*16,14+h*15);e.fillStyle="#00ff4422",e.fillRect(0,0,512,256),e.strokeStyle="#00ff44",e.lineWidth=2,e.strokeRect(4,4,504,248),e.fillStyle="#00ff44",e.font="bold 34px monospace",e.textAlign="center",e.shadowBlur=16,e.shadowColor="#00ff44",e.fillText("MATRIX CORE",256,148),e.shadowBlur=0}),C=s(e=>{e.fillStyle="#05000a",e.fillRect(0,0,512,256),e.strokeStyle="#aa00ff",e.lineWidth=3,e.strokeRect(6,6,500,244),e.strokeStyle="#aa00ff66",e.lineWidth=1,e.strokeRect(16,16,480,224),e.fillStyle="#aa00ff",e.font="bold 40px monospace",e.textAlign="center",e.shadowBlur=20,e.shadowColor="#aa00ff",e.fillText("RESTRICTED",256,100),e.fillText("ACCESS",256,155),e.shadowBlur=0,e.font="16px monospace",e.fillStyle="#aa00ff88",e.fillText("CLEARANCE LEVEL Ω REQUIRED",256,220)}),p=s(e=>{e.fillStyle="#0a0000",e.fillRect(0,0,512,256),e.fillStyle="#ff112244",e.fillRect(0,0,512,256),e.strokeStyle="#ff1122",e.lineWidth=4,e.strokeRect(6,6,500,244),e.fillStyle="#ff1122",e.font="bold 80px monospace",e.textAlign="center",e.fillText("⚠",256,140),e.font="bold 28px monospace",e.fillText("ALERT",256,200),e.font="14px monospace",e.fillStyle="#ff112288",e.fillText("EMERGENCY BROADCAST ACTIVE",256,240)}),w=s(e=>{e.fillStyle="#080400",e.fillRect(0,0,512,256),e.fillStyle="#ff8800";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo(r*28,0),e.lineTo(r*28+28,0),e.lineTo(r*28+28+256,256),e.lineTo(r*28+256,256),e.closePath(),e.fill();e.fillStyle="#080400";for(let r=-4;r<20;r+=2)e.beginPath(),e.moveTo((r+1)*28,0),e.lineTo((r+1)*28+28,0),e.lineTo((r+1)*28+28+256,256),e.lineTo((r+1)*28+256,256),e.closePath(),e.fill();e.fillStyle="#ff8800",e.font="bold 52px monospace",e.textAlign="center",e.fillText("UNDER",256,110),e.fillText("CONSTRUCTION",256,175),e.font="16px monospace",e.fillText("SECTOR 4 - ZONE B",256,230)}),g=[o,a,c,l,v,C,p,w],f=new he(1,1),u=g.map(e=>{const r=new X({map:e,transparent:!1,side:be}),h=new V(f,r,20);return h.frustumCulled=!1,h.count=0,h}),y=new Array(8).fill(0),T=new te,M=new d,E=new oe,P=new d,R=new d(0,1,0),b=8*20;for(let e=0;e<b;e++){const r=e%8,h=y[r];if(h>=20)continue;const k=this.buildings[Math.floor(Math.random()*this.buildings.length)],{wx:O,wz:L,fw:z,fd:Q,h:Ae}=k,N=S(8,22),B=S(4,11),_=Math.min(Ae*.45,28),ve=B*.5+1;if(_<ve)continue;const U=S(ve,_),K=Math.floor(Math.random()*4);let G=O,F=L,D=0;K===0?(F=L+Q/2+.3,D=0):K===1?(F=L-Q/2-.3,D=Math.PI):K===2?(G=O+z/2+.3,D=Math.PI/2):(G=O-z/2-.3,D=-Math.PI/2),M.set(G,U,F),E.setFromAxisAngle(R,D),P.set(N,B,1),T.compose(M,E,P),u[r].setMatrixAt(h,T),y[r]++}for(let e=0;e<8;e++)u[e].count=y[e],u[e].instanceMatrix.needsUpdate=!0,t.add(u[e])}addRooftopEquipment(t){const n=new X({color:526352}),s=new de(1,1,1),o=new we(.5,.5,1,8),a=new we(.05,1,.6,12),c=new V(s,n.clone(),200),l=new V(o,n.clone(),200),v=new V(a,n.clone(),200);c.frustumCulled=l.frustumCulled=v.frustumCulled=!1;let C=0,p=0,w=0;const g=new te,f=new d,u=new d,y=new oe;for(const T of this.buildings){const{wx:M,wz:E,fw:P,fd:R,h:b}=T;if(b<60||Math.random()>.2)continue;const e=re(1,3);for(let r=0;r<e;r++){const h=M+S(-P*.3,P*.3),k=E+S(-R*.3,R*.3),O=Math.random();if(O<.5&&C<200){const L=S(2,6),z=S(3,8),Q=S(2,6);f.set(h,b+z/2,k),u.set(L,z,Q),g.compose(f,y,u),c.setMatrixAt(C++,g)}else if(O<.8&&p<200){const L=S(1,3),z=S(4,10);f.set(h,b+z/2,k),u.set(L*2,z,L*2),g.compose(f,y,u),l.setMatrixAt(p++,g)}else if(w<200){const L=S(2,5);f.set(h,b+.3,k),u.set(L*2,1,L*2),g.compose(f,y,u),v.setMatrixAt(w++,g)}}}c.count=C,c.instanceMatrix.needsUpdate=!0,t.add(c),l.count=p,l.instanceMatrix.needsUpdate=!0,t.add(l),v.count=w,v.instanceMatrix.needsUpdate=!0,t.add(v)}addSearchlights(t){const n=new we(.3,2.5,1,6,1,!0),s=[{color:16777215,opacity:.08,count:34},{color:4521983,opacity:.07,count:26},{color:16729258,opacity:.07,count:20}],o=new te,a=new d,c=new d,l=new oe;for(const v of s){const C=new X({color:v.color,transparent:!0,opacity:v.opacity,side:be,blending:se,depthWrite:!1}),p=new V(n,C,v.count);p.frustumCulled=!1;for(let w=0;w<v.count;w++){const g=re(0,I-1),f=re(0,I-1),u=g*Z-ee,y=f*Z-ee,T=g/I*4-2,M=f/I*4-2,E=Math.max(.18,1-Math.sqrt(T*T+M*M)/3*.6),P=Math.max(8,(22+Re(T,M,5)*170)*E)+S(4,28);a.set(u+S(-2,2),P+150,y+S(-2,2)),c.set(1,300,1),o.compose(a,l,c),p.setMatrixAt(w,o)}p.instanceMatrix.needsUpdate=!0,t.add(p)}}addAntennas(t){const n=new we(.1,.1,1,4),s=new X({color:16716083}),o=new V(n,s,400);o.frustumCulled=!1;const a=new te,c=new d,l=new d,v=new oe;let C=0;for(let p=0;p<400;p++){const w=re(0,I-1),g=re(0,I-1),f=w*Z-ee,u=g*Z-ee,y=w/I*4-2,T=g/I*4-2,M=Math.max(.18,1-Math.sqrt(y*y+T*T)/3*.6),E=Math.max(8,(22+Re(y,T,5)*170)*M)+20,P=S(8,30);c.set(f+S(-3,3),E+P/2,u+S(-3,3)),l.set(1,P,1),a.compose(c,v,l),o.setMatrixAt(C++,a)}o.count=C,o.instanceMatrix.needsUpdate=!0,t.add(o)}addNeonSigns(t,n){n.forEach(({text:s,pos:o,color:a})=>{const c=document.createElement("canvas");c.width=256,c.height=64;const l=c.getContext("2d");l.clearRect(0,0,256,64),l.fillStyle=a+"22",l.fillRect(0,0,256,64),l.strokeStyle=a,l.lineWidth=2,l.strokeRect(2,2,252,60),l.fillStyle=a,l.font="bold 22px monospace",l.textAlign="center",l.fillText(s,128,40);const v=new Ue(c),C=new he(18,4.5),p=new X({map:v,transparent:!0,side:be,depthWrite:!1}),w=new pe(C,p);w.position.copy(o),t.add(w)})}update(t){for(const n of this.mats)n.uniforms.uTime.value=t}}class $t{constructor(){m(this,"mesh");m(this,"mat")}create(t){const n=new he(1200,1200,1,1);return this.mat=new ge({vertexShader:Ot,fragmentShader:Ft,uniforms:{uTime:{value:0},uDistrictNeon:{value:new A(62975)},uRainIntensity:{value:1}}}),this.mesh=new pe(n,this.mat),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=0,t.add(this.mesh),this.mesh}update(t){this.mat.uniforms.uTime.value=t}setDistrictNeon(t){this.mat.uniforms.uDistrictNeon.value.copy(t)}setRainIntensity(t){this.mat.uniforms.uRainIntensity.value=t}}class Kt{constructor(){m(this,"points");m(this,"count",8e3)}create(t){const n=new Float32Array(this.count*3),s=new Float32Array(this.count),o=new Float32Array(this.count);for(let l=0;l<this.count;l++)n[l*3]=S(-300,300),n[l*3+1]=S(-60,60),n[l*3+2]=S(-300,300),s[l]=S(.3,1),o[l]=Math.random();const a=new tt;a.setAttribute("position",new Ce(n,3)),a.setAttribute("aSpeed",new Ce(s,1)),a.setAttribute("aOffset",new Ce(o,1));const c=new ge({vertexShader:Wt,fragmentShader:Ht,uniforms:{uTime:{value:0}},transparent:!0,blending:se,depthWrite:!1});this.points=new ot(a,c),t.add(this.points)}update(t,n){const s=this.points.material;s.uniforms.uTime.value=t,n&&(this.points.position.x=n.x,this.points.position.z=n.z)}}class Zt{constructor(){m(this,"mesh");m(this,"mat")}create(t){const n=new ft(2e3,32,16);this.mat=new ge({vertexShader:zt,fragmentShader:Bt,uniforms:{uTime:{value:0},uZenithColor:{value:new A(132104)},uHorizonColor:{value:new A(1706e3)},uDistrictNeon:{value:new A(62975)}},side:ut,depthWrite:!1}),this.mesh=new pe(n,this.mat),this.mesh.renderOrder=-1,t.add(this.mesh)}update(t,n,s){this.mesh.position.copy(n),this.mat.uniforms.uTime.value=t,s&&this.mat.uniforms.uDistrictNeon.value.copy(s)}setDistrictColors(t,n){this.mat.uniforms.uHorizonColor.value.copy(t),this.mat.uniforms.uDistrictNeon.value.copy(n)}}function Jt(i){let t=i;return()=>{t|=0,t=t+1831565813|0;let n=Math.imul(t^t>>>15,1|t);return n=n+Math.imul(n^n>>>7,61|n)^n,((n^n>>>14)>>>0)/4294967296}}const qe=[new A(16720384),new A(61183),new A(22015),new A(16711884),new A(65382),new A(16737792),new A(11141375),new A(16770626)],Ge=32,nt=16,Qt=6,Oe=nt+Qt,Xe=Ge/2*Oe;class eo{constructor(){m(this,"mesh");m(this,"mat")}create(t){const s=new he(5,1.4),o=new Float32Array(150*3),a=new Float32Array(150),c=new Float32Array(150);s.setAttribute("aColor",new J(o,3)),s.setAttribute("aFlickerSeed",new J(a,1)),s.setAttribute("aPulseMode",new J(c,1)),this.mat=new ge({vertexShader:_t,fragmentShader:Vt,uniforms:{uTime:{value:0}},transparent:!0,depthWrite:!1,side:be,blending:se}),this.mesh=new V(s,this.mat,150),this.mesh.frustumCulled=!1;const l=Jt(42),v=new te,C=new d,p=new oe,w=new d(1,1,1);let g=0;for(let f=0;f<Ge&&g<150;f++)for(let u=0;u<Ge&&g<150;u++){if(f%5===0||u%5===0||l()>.1)continue;const y=f*Oe-Xe,T=u*Oe-Xe,M=6+l()*12,E=Math.floor(l()*4),P=nt*.5+.3;let R=y,b=T,e=0;E===0?(b=T+P,e=0):E===1?(b=T-P,e=Math.PI):E===2?(R=y+P,e=Math.PI*.5):(R=y-P,e=-Math.PI*.5),C.set(R,M,b),p.setFromEuler(new ht(0,e,0)),v.compose(C,p,w),this.mesh.setMatrixAt(g,v);const r=qe[Math.floor(l()*qe.length)];o[g*3]=r.r,o[g*3+1]=r.g,o[g*3+2]=r.b,a[g]=l();const h=l();c[g]=h<.6?0:h<.85?1:h<.95?2:3,g++}this.mesh.count=g,this.mesh.instanceMatrix.needsUpdate=!0,s.getAttribute("aColor").needsUpdate=!0,s.getAttribute("aFlickerSeed").needsUpdate=!0,s.getAttribute("aPulseMode").needsUpdate=!0,t.add(this.mesh)}update(t){this.mat.uniforms.uTime.value=t}}const to=`
