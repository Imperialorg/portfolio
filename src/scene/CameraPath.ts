...
export const SECTION_KEYFRAMES: Array<{
  ...
  { pos: new THREE.Vector3(-80, 58, 48),   look: new THREE.Vector3(-80, 58, 20),    label: 'PS3 GPU',    t: 0 },
  { pos: new THREE.Vector3(-75, 62, 3),    look: new THREE.Vector3(-75, 62, -25),   label: 'CPUonGPU',   t: 0 },
  { pos: new THREE.Vector3(-13, 58, -62),  look: new THREE.Vector3(0,   58, -90),   label: 'GPU Stream', t: 0 },
  { pos: new THREE.Vector3(19, 58, -82),   look: new THREE.Vector3(40,  58, -110),  label: 'Selkies',    t: 0 },
  { pos: new THREE.Vector3(90, 58, -71),   look: new THREE.Vector3(100, 58, -100),  label: 'Oris AI',    t: 0 },
  { pos: new THREE.Vector3(101, 58, 8),    look: new THREE.Vector3(90,  58, -20),   label: 'VajraGrid',  t: 0 },
  { pos: new THREE.Vector3(84, 55, 76),    look: new THREE.Vector3(70,  55, 50),    label: 'VidyaMitra', t: 0 },
  { pos: new THREE.Vector3(34, 55, 106),   look: new THREE.Vector3(20,  55, 80),    label: 'Netflip',    t: 0 },
  { pos: new THREE.Vector3(-5, 55, 96),    look: new THREE.Vector3(-20, 55, 70),    label: 'Arena',      t: 0 },
  { pos: new THREE.Vector3(-20, 62, 67),   look: new THREE.Vector3(-10, 62, 40),    label: 'Hackathon',  t: 0 },
