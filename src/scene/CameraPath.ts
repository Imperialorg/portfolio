...
export const SECTION_KEYFRAMES: Array<{
  ...
  { pos: new THREE.Vector3(-80, 58, 65),   look: new THREE.Vector3(-80, 58, 20),    label: 'PS3 GPU',    t: 0 },
  { pos: new THREE.Vector3(-75, 62, 25),   look: new THREE.Vector3(-75, 62, -25),   label: 'CPUonGPU',   t: 0 },
  { pos: new THREE.Vector3(-30, 58, -35),  look: new THREE.Vector3(0,   58, -90),   label: 'GPU Stream', t: 0 },
  { pos: new THREE.Vector3(20, 58, -55),   look: new THREE.Vector3(40,  58, -110),  label: 'Selkies',    t: 0 },
  { pos: new THREE.Vector3(80, 58, -45),   look: new THREE.Vector3(100, 58, -100),  label: 'Oris AI',    t: 0 },
  { pos: new THREE.Vector3(110, 58, 30),   look: new THREE.Vector3(90,  58, -20),   label: 'VajraGrid',  t: 0 },
  { pos: new THREE.Vector3(100, 55, 100),  look: new THREE.Vector3(70,  55, 50),    label: 'VidyaMitra', t: 0 },
  { pos: new THREE.Vector3(50, 55, 130),   look: new THREE.Vector3(20,  55, 80),    label: 'Netflip',    t: 0 },
  { pos: new THREE.Vector3(10, 55, 120),   look: new THREE.Vector3(-20, 55, 70),    label: 'Arena',      t: 0 },
  { pos: new THREE.Vector3(-30, 62, 90),   look: new THREE.Vector3(-10, 62, 40),    label: 'Hackathon',  t: 0 },
